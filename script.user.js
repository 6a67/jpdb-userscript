...
`});a=d.querySelector(".subsection-label");a&&((e=document.createElement("button")).classList.add("kanji-copy-button"),(o=document.createElementNS("http://www.w3.org/2000/svg","svg")).setAttribute("xmlns","http://www.w3.org/2000/svg"),o.setAttribute("viewBox","0 0 24 24"),o.classList.add("kanji-copy-button-svg"),o.innerHTML='<path d="M0 0h24v24H0V0z" fill="none"/><path d="M16 1H4c-1.1 0-2 .9-2 2v14h2V3h12V1zm3 4H8c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h11c1.1 0 2-.9 2-2V7c0-1.1-.9-2-2-2zm0 16H8V7h11v14z"/>',d=window.getComputedStyle(a),o.style.width=d.fontSize,o.style.height=d.fontSize,e.appendChild(o),e.addEventListener("click",()=>{GM_setClipboard(c.trim())}),document.dispatchEvent(new CustomEvent("kanjiComponents",{detail:{componentString:c.trim()}})),a.appendChild(e))}}}}}}function D(){let a=(()=>{let t=new Map;return function(a){document.querySelectorAll(".deck").forEach(e=>{e.querySelectorAll('input[type="hidden"][name="delta"]').forEach(e=>{a?(t.set(e,e.value),e.value*=9999):e.value=t.get(e)||e.value})})}})();document.addEventListener("keydown",function(e){"Shift"===e.key&&a(!0)}),document.addEventListener("keyup",function(e){"Shift"===e.key&&a(!1)})}function P(){document.addEventListener("keydown",function(e){var a,t;"Enter"===e.key&&e.ctrlKey&&(a=(e=e).target,t=a.closest("form"))&&a.matches("input")&&["text","search"].includes(a.type)&&(e.preventDefault(),(a=t.cloneNode(!0)).target="_blank",document.body.appendChild(a),a.submit(),document.body.removeChild(a),window.focus())})}function M(){let e=document.querySelector(".injected-search-overlay");var a;e&&(a=e.firstElementChild,p.searchBarOverlayTransition()?(e.style.backgroundColor="rgba(0, 0, 0, 0)",e.style.backdropFilter="blur(0px)",a.style.transform="scale(0.75)",a.style.opacity="0",setTimeout(()=>{document.body.removeChild(e)},y.searchOverlayTransitionDuration)):document.body.removeChild(e))}async function A(){var t=document.querySelector(".injected-search-overlay");if(!t){t=await s("https://jpdb.io/",86400,!0),t=(new DOMParser).parseFromString(t.responseText,"text/html").querySelector('form[action="/search#a"]');if(t){t=t.cloneNode(!0);let a=document.createElement("div"),e=(a.classList.add("injected-search-overlay"),a.style.cssText=`
        ...
        `,document.createElement("div"));p.searchBarOverlayTransition()&&(e.style.cssText=`
            ...
            min-width: 40vw;
            max-width: 80vw;
        `,p.searchBarOverlayTransition()&&setTimeout(()=>{a.style.backgroundColor="rgba(0, 0, 0, 0.7)",a.style.backdropFilter="blur(1px)",e.style.transform="scale(1)",e.style.opacity="1"},10),a.addEventListener("keydown",function(e){["Escape","Enter","/"].includes(e.key)||e.ctrlKey||e.altKey||e.metaKey||e.stopPropagation(),"Escape"===e.key&&M()}),document.addEventListener("keydown",function(e){"Escape"===e.key&&M()},{once:!0}),a.addEventListener("click",e=>{e.target===a&&M()}),a}}}function V(e){var a,t;a=document.activeElement,t=a.isContentEditable,a!==document.body&&(t||["text","search"].includes(a.type))||(e.preventDefault(),(t=document.querySelector('input[type="search"]'))?t.focus():A())}function F(){let o=document.querySelector('form[action="/settings"]');if(o){var e=o.querySelectorAll("div"),e=Array.from(e).reverse().find(e=>e.querySelector('input[type="submit"]'));if(e){let d="";for(let c of Object.values(p)){let e=0,a=c.getDependency(),t=a;for(;null!==a;)t=a,e+=1.5,a=a.getDependency();var n=e+"rem",f=null!==t&&(!t()||t()!==c.getDependency()())?' class="hidden"':"";c.getPossibleValues()?d+=`
                            <div style="display: flex; align-items: baseline; flex-wrap: wrap; gap: 1rem; margin-left: ${n};"${f}>
...
${c.getLongDescription()}
        ...
        `,document.head.appendChild(t),e.checked=!0,a.offsetHeight,document.head.removeChild(t)),N(),new MutationObserver(e=>{e.forEach(e=>{"childList"===e.type&&e.addedNodes.forEach(e=>{e&&e.classList&&e.classList.contains("subsection-composed-of-kanji")?N():e&&e.querySelectorAll&&e.querySelectorAll(".subsection-composed-of-kanji").forEach(e=>{N()})})})}).observe(document.body,{childList:!0,subtree:!0}),P(),document.addEventListener("keydown",function(e){"/"===e.key&&V(e)}),p.enableSentenceBlur()&&(GM_addStyle(b.sentenceBlur),document.addEventListener("click",function(e){e.target.classList.contains("sentence-translation")&&e.target.classList.toggle("unblur")})),p.enableMonolingualMachineTranslation()&&z(),p.enableButtonSound()&&(async()=>{r.audioContext.ctx||(r.audioContext.ctx=new(window.AudioContext||window.webkitAudioContext))})(),document.dispatchEvent(new CustomEvent(GM_info.script.name+"-initialized"))}try{l()}catch(e){}if("loading"===document.readyState)document.addEventListener("DOMContentLoaded",T);else try{T()}catch(e){}})();
