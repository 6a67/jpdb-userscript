...
// ==/UserScript==
(()=>{class e{constructor(e,a,t,c="",d=null,o=1,n=99999,r=null,f=!1,i=!1){this.name=e,this.defaultValue=a,this.shortDescription=t,this.longDescription=c,this.possibleValues=d,this.minVal=o,this.maxVal=n,this.dependency=r,this.largeTextField=f,this.colorPicker=i,this.value=this.validateValue(GM_getValue(e,a));t=(...e)=>(0<e.length&&this.setValue(e[0]),this.getValue());return t.getValue=this.getValue.bind(this),t.setValue=this.setValue.bind(this),t.getName=this.getName.bind(this),t.getShortDescription=this.getShortDescription.bind(this),t.getLongDescription=this.getLongDescription.bind(this),t.getPossibleValues=this.getPossibleValues.bind(this),t.getMinVal=this.getMinVal.bind(this),t.getMaxVal=this.getMaxVal.bind(this),t.getDependency=this.getDependency.bind(this),t.getLargeTextField=this.getLargeTextField.bind(this),t.getColorPicker=this.getColorPicker.bind(this),t}validateValue(e){return this.possibleValues&&!this.possibleValues.includes(e)||"number"==typeof e&&(e<this.minVal||e>this.maxVal)?(console.warn(`Invalid value for ${this.name}. Using default value.`),this.defaultValue):e}getValue(){return this.value}setValue(e){e=this.validateValue(e);e!==this.value&&(this.value=e,GM_setValue(this.name,e))}getName(){return this.name}getShortDescription(){return this.shortDescription}getLongDescription(){return this.longDescription}getPossibleValues(){return this.possibleValues}getMinVal(){return this.minVal}getMaxVal(){return this.maxVal}getDependency(){return this.dependency}getLargeTextField(){return this.largeTextField}getColorPicker(){return this.colorPicker}}let f={currentlyBuildingKanjiCache:!1,cachedEffects:GM_getValue("cachedEffects",!1),warmingEffectsPromise:null,revealEffectPlayed:!1,audioContext:{ctx:null,src:null,gain:null},apiKey:GM_getValue("apiKey",""),currentVersion:GM_getValue("debug_currentVersion",""),previousVersion:GM_getValue("debug_previousVersion","")},i={},y={apiBaseUrl:"https://jpdb.io/api/v1",learnPageUrl:"https://jpdb.io/learn",deckListPageUrl:"https://jpdb.io/deck-list",reviewPageUrlPrefix:"https://jpdb.io/review",settingsPageUrl:"https://jpdb.io/settings",shownSentencePrefix:"https://jpdb.io/edit-shown-sentence",editAudioPrefix:"https://jpdb.io/edit-audio",deckListClass:"deck-list",deckListSelector:"div.deck-list",newDeckListClass:"injected-deck-list",newDeckListSelector:"div.injected-deck-list",deckListLinkSelector:'a[href="/deck-list"]',reviewButtonSelector:'.review-button-group input[type="submit"]',strokeOrderHost:"https://github.com",strokeOrderRawHost:"https://raw.githubusercontent.com",strokeOrderRepo:"KanjiVG/kanjivg",strokeOrderFolder:"kanji",strokeOrderBranch:"master",kanjiSvgSelector:".kanji svg",kanjiPlainSelector:".kanji.plain",searchOverlayTransitionDuration:200,cachePrefix:"cache_",indexedDBName:"HttpRequestCache",indexedDBStoreName:"responses",soundUrlFail:"https://d35aaqx5ub95lt.cloudfront.net/sounds/f0b6ab4396d5891241ef4ca73b4de13a.mp3",soundUrlHard:"https://d35aaqx5ub95lt.cloudfront.net/sounds/a28ff0a501ef5f33ca78c0afc45ee53e.mp3",soundUrlOkay:"https://d35aaqx5ub95lt.cloudfront.net/sounds/37d8f0b39dcfe63872192c89653a93f6.mp3",soundUrlEasy:"https://d35aaqx5ub95lt.cloudfront.net/sounds/2aae0ea735c8e9ed884107d6f0a09e35.mp3",soundUrlReveal:"https://files.catbox.moe/hzxzzb.ogg",lottieSparkles:["https://d35aaqx5ub95lt.cloudfront.net/lottie/e13df96082d0e4dbc6d78b6f5346e2a2.json","https://d35aaqx5ub95lt.cloudfront.net/lottie/b50a27f803ddd071fdbd83af2fc05c8a.json"],lottieSmallFireworks:["https://files.catbox.moe/1ggh8q.json","https://files.catbox.moe/5t0xm4.json"],lottieBigFireworks:["https://files.catbox.moe/cb35i9.json"],lottieExplosions:["https://d35aaqx5ub95lt.cloudfront.net/lottie/2a62162ea93d55dee67189cc47bd98ab.json"]},d={enableCacheLogs:!1,enableProgress:GM_getValue("progress_enableProgress",!1)},r={None:{},ja:{Kanji:"漢字","Type a word, a kanji, or a sentence":"単語、漢字、または文章を入力してください",Settings:"設定",Logout:"ログアウト",Stats:"統計",Vocabulary:"単語",Component:"部品","Show answer":"答えを表示","✘ Nothing":"✘ 全然","✘ Something":"✘ 何か","✔ Hard":"✔ 難しい","✔ Okay":"✔ 大丈夫","✔ Easy":"✔ 簡単",Blacklist:"ブラックリスト","I'll never forget":"絶対に忘れない","I know this, will never forget":"完全に覚えている、絶対に忘れない","I know this, but may forget":"知っているが、忘れる可能性がある","I don't know this":"これは知らない",[String.raw`/^Words \((.*?)\)$/`]:"単語（{1}）",[String.raw`/^Kanji \((.*?)\)$/`]:"漢字（{1}）","Learn (":"学習 (","Built-in decks":"内蔵デッキ","Start reviewing":"復習を始める","Welcome back!":"お帰りなさい！",Quiz:"クイズ",Leaderboard:"リーダーボード",Meanings:"意味","config.reviewButtonFontWeight":"500"}};var a,t,c;(a={}).enableButtonStyling=new e("enableButtonStyling",!0,"Button styling","Apply custom styles to review page buttons."),a.enableButtonEffects=new e("enableButtonEffects",!0,"Button effects","",null,0,1,a.enableButtonStyling),a.enableButtonSound=new e("enableButtonSound",!0,"Button sounds","",null,0,1,a.enableButtonStyling),a.buttonSoundVolume=new e("buttonSoundVolume",.7,"Button sound volume","",null,0,1,a.enableButtonSound),a.buttonSoundDelay=new e("buttonSoundDelay",-1,"Button sound delay","Set delay before redirect after sound plays. -1 for auto-detect, large negative to disable.",null,-99999,99999,a.enableButtonSound),a.enableReplaceKanjiStrokeOrder=new e("enableReplaceKanjiStrokeOrder",!0,"KanjiVG stroke order",""),a.useFontInsteadOfSvg=new e("useFontInsteadOfSvg",!1,"Font-based stroke order","Use font instead of SVG for stroke order.",null,0,1,a.enableReplaceKanjiStrokeOrder),a.enableSentenceBlur=new e("enableSentenceBlur",!0,"Blur translations","Blur sentence translations on card back. Click to toggle."),a.enableVerticalSentence=new e("enableVerticalSentence",!1,"Vertical sentences on review cards"),a.searchBarOverlayTransition=new e("searchBarOverlayTransition",!1,"Search overlay animation"),a.alwaysShowKanjiGrid=new e("alwaysShowKanjiGrid",!0,"Always show kanji grid"),a.autoExpandNavMenu=new e("autoExpandNavMenu",!1,"Auto-expand the navigation menu on review page"),a.enableMonolingualMachineTranslation=new e("enableMonolingualMachineTranslation",!0,"Machine translation for monolingual sentences","Shows a placeholder sentence that can be clicked to translate the sentence using JPDBs machine translation."),a.translationLanguage=new e("translation","None","Partial translation",null,Object.keys(r)),a.showAdvancedSettings=new e("showAdvancedSettings",!1,"Show advanced settings"),a.advancedStaticUserButtonsOnSmallScreens=new e("advancedStaticUserButtonsOnSmallScreens",!1,"Static user buttons on small screens","Move the answer buttons to the bottom of the page on small screens instead of floating."),a.advancedYomiVocabAudioServer=new e("advancedYomiVocabAudioServer","","Yomi vocab audio server (experimental)","A comma-separated list of URLs with '{term}' as placeholder (e.g. 'http://localhost:5050/?term={term}') that can be used to set custom audio for vocabularies.",null,0,0,a.showAdvancedSettings,!0),a.advancedUseExperimentalThemeGenerator=new e("advancedUseExperimentalThemeGenerator",!1,"Use experimental theme generator","",null,0,1,a.showAdvancedSettings),a.advancedDarkModeBackgroundColor=new e("advancedDarkModeBackgroundColor","#151f24","Dark mode background color","",null,0,0,a.advancedUseExperimentalThemeGenerator,!1,!0),a.advancedDarkModeContrastColor=new e("advancedDarkModeContrastColor","#00ffaa","Dark mode contrast color","",null,0,0,a.advancedUseExperimentalThemeGenerator,!1,!0),a.advancedCustomCSS=new e("advancedCustomCSS","","Custom CSS","",null,0,0,a.showAdvancedSettings,!0);let p=a,b={main:`
            :root {
            ...
            .dark-mode {
                ${p.advancedUseExperimentalThemeGenerator()?(a=p.advancedDarkModeBackgroundColor(),t=p.advancedDarkModeContrastColor(),`
            --text-color: ${(c={textColor:c=n("#"+(16777215^parseInt(a.slice(1),16)).toString(16).padStart(6,"0").toUpperCase(),t,.8),textStrongColor:n(c,(e=>{e=e.replace("#","");let a=3===e.length?e.split("").map(e=>e+e).join(""):e;var[e,t,c]=[0,2,4].map(e=>parseInt(a.slice(e,e+2),16));return 128<.299*e+.587*t+.114*c})(a)?"#000000":"#ffffff",.2),backgroundColor:a,deeperBackgroundColor:o(a,-10),foregroundBackgroundColor:o(a,20),linkColor:t,highlightColor:n(a,t,.8),buttonBackgroundColor:n(a,t,.8),inputBackgroundColor:o(a,10),inputBorderColor:o(a,40),scrollbarColor:t,mnemonicMain:o(t,-20),mnemonicComponent:n(a,t,.9),progressBarForeground:`linear-gradient(${n(o(t,-40),c,.6)}, ${n(o(t,-120),c,.6)})`,focusedColor:n(o(t,-40),c,.8),whatIsThisColor:o(a,120),subsectionLabelColor:o(a,150),propertyTextColor:o(a,150),stateNew:t,stateBlacklisted:o(a,120),stateKnown:"#4fa825",stateOverdue:"#ff8c42",stateFailed:"#ff3b3b"}).textColor};
            --text-strong-color: ${c.textStrongColor};
            --background-color: ${c.backgroundColor};
            --deeper-background-color: ${c.deeperBackgroundColor};
            --foreground-background-color: ${c.foregroundBackgroundColor};
            --link-underline-color: ${c.linkColor};
            --link-color: ${c.linkColor};
            --highlight-color: ${c.highlightColor};
            --checkbox-focused-border-color: ${c.focusedColor};
            --checkbox-background-color: ${c.deeperBackgroundColor};
            --checkbox-focused-box-shadow-color: ${c.focusedColor};
            --button-background-color: ${c.buttonBackgroundColor};
            --button-focused-border-color: ${c.focusedColor};
            --outline-input-background-color-review: ${c.deeperBackgroundColor};
            --outline-input-background-color: ${c.inputBackgroundColor};
            --answer-box-color: ${c.foregroundBackgroundColor};
            --table-border-color: ${c.inputBorderColor};
            --spelling-box-background-color: ${c.highlightColor};
            --input-border-color: ${c.inputBorderColor};
            --input-background-color: ${c.inputBackgroundColor};
            --input-box-shadow-color: ${c.deeperBackgroundColor};
            --scrollbar-color: ${c.scrollbarColor};
            --scrollbar-background-color: ${c.deeperBackgroundColor};
            --mnemonic-main: ${c.mnemonicMain};
            --mnemonic-component: ${c.mnemonicComponent};
            --background-button-border-color: ${c.inputBorderColor};
            --big-shadow-color: ${o(c.deeperBackgroundColor,-10)};
            --progress-bar-background: ${c.foregroundBackgroundColor};
            --progress-bar-foreground: ${c.progressBarForeground};
            --progress-bar-in-progress: ${c.inputBorderColor};
            --review-button-group-border: ${c.inputBorderColor};

            --focused-arrow-color: ${c.focusedColor};
            --what-is-this-color: ${c.whatIsThisColor};
            --what-is-this-focus-color: ${c.focusedColor};
            --what-is-this-focus-shadow-color: ${c.highlightColor};
            --checkbox-color: ${c.focusedColor};
            --checkbox-focused-text-underline-color: ${c.focusedColor};
            --button-hover-border-color: ${c.focusedColor};
            --outline-input-color: ${c.focusedColor};

            --outline-input-shadow-color: ${c.focusedColor};
            --subsection-label-color: ${c.subsectionLabelColor};
            --table-header-color: ${c.subsectionLabelColor};
            --input-focused-border-color: ${c.focusedColor};

            --property-text-color: ${c.propertyTextColor};
            --state-new: ${c.stateNew};
            --state-blacklisted: ${c.stateBlacklisted};
            --state-known: ${c.stateKnown};
            --state-overdue: ${c.stateOverdue};
            --state-failed: ${c.stateFailed};
            `):`
                --text-color: #ddd;
...
`});a=d.querySelector(".subsection-label");a&&((e=document.createElement("button")).classList.add("kanji-copy-button"),(o=document.createElementNS("http://www.w3.org/2000/svg","svg")).setAttribute("xmlns","http://www.w3.org/2000/svg"),o.setAttribute("viewBox","0 0 24 24"),o.classList.add("kanji-copy-button-svg"),o.innerHTML='<path d="M0 0h24v24H0V0z" fill="none"/><path d="M16 1H4c-1.1 0-2 .9-2 2v14h2V3h12V1zm3 4H8c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h11c1.1 0 2-.9 2-2V7c0-1.1-.9-2-2-2zm0 16H8V7h11v14z"/>',d=window.getComputedStyle(a),o.style.width=d.fontSize,o.style.height=d.fontSize,e.appendChild(o),e.addEventListener("click",()=>{GM_setClipboard(c.trim())}),document.dispatchEvent(new CustomEvent("kanjiComponents",{detail:{componentString:c.trim()}})),a.appendChild(e))}}}}}}function A(){let a=(()=>{let t=new Map;return function(a){document.querySelectorAll(".deck").forEach(e=>{e.querySelectorAll('input[type="hidden"][name="delta"]').forEach(e=>{a?(t.set(e,e.value),e.value*=9999):e.value=t.get(e)||e.value})})}})();document.addEventListener("keydown",function(e){"Shift"===e.key&&a(!0)}),document.addEventListener("keyup",function(e){"Shift"===e.key&&a(!1)})}function P(){document.addEventListener("keydown",function(e){var a,t;"Enter"===e.key&&e.ctrlKey&&(a=(e=e).target,t=a.closest("form"))&&a.matches("input")&&["text","search"].includes(a.type)&&(e.preventDefault(),(a=t.cloneNode(!0)).target="_blank",document.body.appendChild(a),a.submit(),document.body.removeChild(a),window.focus())})}function T(){let e=document.querySelector(".injected-search-overlay");var a;e&&(a=e.firstElementChild,p.searchBarOverlayTransition()?(e.style.backgroundColor="rgba(0, 0, 0, 0)",e.style.backdropFilter="blur(0px)",a.style.transform="scale(0.75)",a.style.opacity="0",setTimeout(()=>{document.body.removeChild(e)},y.searchOverlayTransitionDuration)):document.body.removeChild(e))}async function V(){var t=document.querySelector(".injected-search-overlay");if(!t){t=await l("https://jpdb.io/",86400,!0),t=(new DOMParser).parseFromString(t.responseText,"text/html").querySelector('form[action="/search#a"]');if(t){t=t.cloneNode(!0);let a=document.createElement("div"),e=(a.classList.add("injected-search-overlay"),a.style.cssText=`
        ...
        `,document.createElement("div"));p.searchBarOverlayTransition()&&(e.style.cssText=`
            ...
            min-width: 40vw;
            max-width: 80vw;
        `,p.searchBarOverlayTransition()&&setTimeout(()=>{a.style.backgroundColor="rgba(0, 0, 0, 0.7)",a.style.backdropFilter="blur(1px)",e.style.transform="scale(1)",e.style.opacity="1"},10),a.addEventListener("keydown",function(e){["Escape","Enter","/"].includes(e.key)||e.ctrlKey||e.altKey||e.metaKey||e.stopPropagation(),"Escape"===e.key&&T()}),document.addEventListener("keydown",function(e){"Escape"===e.key&&T()},{once:!0}),a.addEventListener("click",e=>{e.target===a&&T()}),a}}}function G(e){var a,t;a=document.activeElement,t=a.isContentEditable,a!==document.body&&(t||["text","search"].includes(a.type))||(e.preventDefault(),(t=document.querySelector('input[type="search"]'))?t.focus():V())}function F(){let o=document.querySelector('form[action="/settings"]');if(o){var e=o.querySelectorAll("div"),e=Array.from(e).reverse().find(e=>e.querySelector('input[type="submit"]'));if(e){let d="";for(let c of Object.values(p)){let e=0,a=c.getDependency(),t=a;for(;null!==a;)t=a,e+=1.5,a=a.getDependency();var n=e+"rem",r=null!==t&&(!t()||t()!==c.getDependency()())?' class="hidden"':"";c.getPossibleValues()?d+=`
                            <div style="display: flex; align-items: baseline; flex-wrap: wrap; gap: 1rem; margin-left: ${n};"${r}>
                                <label for="${c.getName()}">${c.getShortDescription()}</label>
                                <select id="${c.getName()}" name="${c.getName()}" style="flex-grow: 0;flex-shrink: 1;width: auto;margin-left: 0.3rem; font-family: monospace;">
                                    ${c.getPossibleValues().map(e=>`<option value="${e}" ${c()===e?"selected":""}>${e}</option>`).join("")}
                                </select>
                                ${c.getLongDescription()?`<p style="opacity: 0.8;">
${c.getLongDescription()}
</p>`:""}
                            </div>
                        `:"boolean"==typeof c()?d+=`
                            <div style="margin-left: ${n};"${r}>
                            <div class="checkbox">
                                <input type="checkbox" id="${c.getName()}" name="${c.getName()}" ${c()?"checked":""}>
                                <label for="${c.getName()}">${c.getShortDescription()}</label>
                            </div>
                            ${c.getLongDescription()?`<p style="margin-left: 2rem; opacity: 0.8;">
${c.getLongDescription()}
</p>`:""}
                            </div>
                        `:"number"==typeof c()?d+=`
                            <div style="margin-left: ${n};"${r}>
                                <label for="${c.getName()}">${c.getShortDescription()}</label>
                                <input style="max-width: 16rem;" type="number" id="${c.getName()}" name="${c.getName()}" step="any" value="${c()}">
                                ${c.getLongDescription()?`<p style="opacity: 0.8;">
${c.getLongDescription()}
</p>`:""}
                            </div>
                        `:c.getLargeTextField()?d+=`
                            <div style="margin-left: ${n};"${r}>
                                <label for="${c.getName()}">${c.getShortDescription()}</label>
                                ${c.getLongDescription()?`<p style="opacity: 0.8; margin-top: 0.5rem">
${c.getLongDescription()}
</p>`:""}
                                <textarea id="${c.getName()}" name="${c.getName()}" style="width: 100%; height: 10rem; margin-top: 0.5rem;" spellcheck="false">${c()}</textarea>
                            </div>
                        `:c.getColorPicker()?d+=`
                            <div style="margin-left: ${n};"${r}>
                                <label for="${c.getName()}">${c.getShortDescription()}</label>
                                <input type="color" id="${c.getName()}" name="${c.getName()}" value="${c()}" style="appearance: none; border: none; background: none;">
                                ${c.getLongDescription()?`<p style="opacity: 0.8;">
${c.getLongDescription()}
</p>`:""}
                            </div>
                        `:d+=`
                            <div style="margin-left: ${n};"${r}>
                                <label for="${c.getName()}">${c.getShortDescription()}</label>
                                <input style="max-width: 16rem;" type="text" id="${c.getName()}" name="${c.getName()}" value="${c()}">
                                ${c.getLongDescription()?`<p style="opacity: 0.8;">
${c.getLongDescription()}
</p>`:""}
                            </div>
                ...
                `;e.previousSibling.insertAdjacentHTML("beforebegin",f),document.getElementById("build-kanji-cache").addEventListener("click",function(e){e.preventDefault(),$()});let a=document.getElementById("reset-settings"),t=(a.addEventListener("click",function(e){e.preventDefault();GM_listValues().forEach(e=>{GM_deleteValue(e)});e=0===GM_listValues().length;a.parentElement.parentElement.querySelector("p").textContent=e?"Settings reset successfully.":"Settings reset failed.",o.submit()}),document.getElementById("reset-kanji-cache"));t.addEventListener("click",function(e){e.preventDefault(),new Promise((a,t)=>{var e=indexedDB.deleteDatabase(y.indexedDBName);e.onerror=e=>{console.error(`Error deleting database ${y.indexedDBName}:`,e.target.error),t(e.target.error)},e.onsuccess=e=>{console.log(`Database ${y.indexedDBName} successfully deleted`),a()},e.onblocked=e=>{console.warn(`Database ${y.indexedDBName} deletion blocked. Please close all other tabs with this site open.`)}}),t.parentElement.parentElement.querySelector("p").textContent="Kanji cache reset.",o.submit()});for(c of Object.values(p)){var i=c.getDependency();if(i){var b=o.querySelector(`[name="${c.getName()}"]`),s=o.querySelector(`[name="${i.getName()}"]`);if(b&&s&&!s.dataset.dependent){let a=[];for(var l of Object.values(p)){var u=l.getDependency();u&&u.getName()===i.getName()&&a.push(l)}s.addEventListener("change",function(){for(var e of a){e=o.querySelector(`[name="${e.getName()}"]`);("checkbox"===e.type?e.parentElement:e).parentElement.classList.toggle("hidden"),e.dispatchEvent(new Event("change"))}}),s.dataset.dependent="true"}}}o.addEventListener("submit",function(e){e.preventDefault();for(var a of Object.values(p)){var t=o.querySelector(`input[name="${a.getName()}"]`)||o.querySelector(`textarea[name="${a.getName()}"]`),c=o.querySelector(`select[name="${a.getName()}"]`);t?"boolean"==typeof a()?a(t.checked):"number"==typeof a()?a(Number(t.value)):a(t.value):c&&a(c.value)}this.submit()})}}}async function z(){let a=!1;function d(e){var a=p.translationLanguage();if("None"!==a&&r[a]){var t,c,d,o=(t=(t=e)&&"string"==typeof t?(t=t.replace(/<script[^>]*>([\S\s]*?)<\/script>/gim,"")).replace(/<\/?\w(?:[^"'>]|"[^"]*"|'[^']*')*>/gim,""):t).normalize("NFKC");if(r[a][o.trim()])return r[a][o.trim()];for([c,d]of Object.entries(r[a]))if(c.startsWith("/")&&c.endsWith("/")){var n=new RegExp(c.slice(1,-1));let t=o.trim().match(n);if(t){let a=d;for(let e=0;e<t.length;e++)a=a.replace(new RegExp(`\\{${e}\\}`,"g"),()=>t[e]||"");return a}}}return e}function t(){var e;a=!0;for(e of document.getElementsByTagName("*"))(c=>{if(c.nodeType===Node.ELEMENT_NODE&&!c.classList.contains("translated")){let t=!1;c.childNodes.forEach(e=>{var a;e.nodeType===Node.TEXT_NODE&&(a=e.textContent.trim())&&a!==(a=d(a))&&(e.textContent=a,t=!0)});var e;["placeholder","value","title","alt","aria-label"].forEach(e=>{var a;c.hasAttribute(e)&&(a=c.getAttribute(e))!==(a=d(a))&&(c.setAttribute(e,a),t=!0)}),"INPUT"===c.tagName&&"submit"===c.type&&(e=c.value)!==(e=d(e))&&(c.value=e,t=!0),"META"===c.tagName&&"description"===c.name&&(e=c.content)!==(e=d(e))&&(c.content=e,t=!0),t&&(c.setAttribute("lang",p.translationLanguage()),c.classList.add("translated"))}})(e);a=!1}new MutationObserver(e=>{a||(a=!0,e.forEach(e=>{"childList"===e.type?e.addedNodes.forEach(e=>{e.nodeType===Node.ELEMENT_NODE&&t()}):"attributes"===e.type&&t()}),a=!1)}).observe(document.body,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["placeholder","value","title","alt","aria-label"]}),t()}function U(){async function r(e,a=604800){var e=await l(`https://jpdb.io/search?q=${encodeURIComponent(e)}&lang=english#a`,a,!1,!1,!0,!1),t=(new DOMParser).parseFromString(e.responseText,"text/html").querySelector("#machine-translation");return t.classList.contains("translation-in-progress")?{success:!0,translation:(await l("https://jpdb.io/translation?id="+e.responseText.match(/translation\?id=(\d+)/)[1],a,!1,!1,!0,!1)).responseText.trim()}:t?{success:!0,translation:t.textContent.trim()}:{success:!1,translation:""}}function f(e){var e=e.cloneNode(!0),a=document.createElement("div");return a.appendChild(e),a.querySelectorAll("ruby rt").forEach(e=>e.remove()),a.innerText.replace(/<br>/g,"\n").replace(/\n/g," ").replace(/<[^>]*>/g,"").trim()}function a(){document.querySelectorAll(".used-in").forEach(e=>{let d=e.querySelector(".jp"),a=e.querySelector(".en");if(d&&!a){let c=document.createElement("div");c.classList.add("en"),c.classList.add("pending-translation"),c.textContent="Click to translate",e.appendChild(c);const o=604800;c.addEventListener("click",async function e(){var a=f(d),{success:a,translation:t}=(c.textContent="Translating...",await r(a,o));a?(c.textContent=t,c.classList.remove("pending-translation"),c.removeEventListener("click",e)):(c.textContent="Translation failed. Click to try again.",o=0)})}});let o=document.querySelector(".card-sentence");var e=document.querySelector(".review-reveal"),a=o?.parentElement?.querySelector(".sentence-translation");if(o&&!a&&e){let d=o.querySelector(".sentence");o.insertAdjacentHTML("afterend",'<div style="display: flex;justify-content: center;"><div class="sentence-translation" style="">Click to translate</div></div>');const n=604800;o.nextElementSibling.querySelector(".sentence-translation").addEventListener("click",async function e(){var a=f(d),t=o.nextElementSibling.querySelector(".sentence-translation"),{success:a,translation:c}=(t.textContent="Translating...",await r(a));a?(t.textContent=c,t.classList.remove("pending-translation"),t.removeEventListener("click",e)):(t.textContent="Translation failed. Click to try again.",n=0)})}}new MutationObserver(e=>{e.forEach(e=>{"childList"===e.type&&e.addedNodes.forEach(e=>{e.nodeType===Node.ELEMENT_NODE&&a()})})}).observe(document.body,{childList:!0,subtree:!0}),a()}function D(e,a){e=e.getBoundingClientRect();return a.getBoundingClientRect().top-e.bottom}function O(e,a){e=e.getBoundingClientRect();return a.getBoundingClientRect().top-e.top}async function _(){async function d(){let e=null;e=document.querySelector(".review-reveal")?await l("https://jpdb.io/stats",9999):await l("https://jpdb.io/stats",3);var a=(new DOMParser).parseFromString(e.responseText,"text/html").querySelectorAll("script");let t=null;if(a.forEach(e=>{e.textContent.includes('document.getElementById("chart")')&&(t=e)}),t){let e=t.textContent.match(new RegExp(/var\s?data\s?=\s?({\s?.+?\s?});/))[1];e=(e=e.replace(/(['"])?([a-zA-Z0-9_]+)(['"])?:/g,'"$2": ')).replace(/,(\s*[}\]])/g,"$1");var a=JSON.parse(e),c=a.datasets.find(e=>e.label.toLowerCase().includes("old")&&e.label.toLowerCase().includes("failed")),d=a.datasets.find(e=>e.label.toLowerCase().includes("old")&&e.label.toLowerCase().includes("passed")),a=a.datasets.find(e=>e.label.toLowerCase().includes("new"));return{oldCardsCount:c.data[c.data.length-1]+d.data[d.data.length-1],newCardsCount:a.data[a.data.length-1]}}return{oldCardsCount:0,newCardsCount:0}}async function t(){let e=(a=document.querySelector('.nav-item[href*="/learn"]').querySelector("span"))&&"red"===getComputedStyle(a).color||"rgb(255, 0, 0)"===getComputedStyle(a).color?Number(a.textContent):0;var{oldCardsCount:a,newCardsCount:t}=await d(),a=a+t,c=(0<t&&(c=await l("https://jpdb.io/settings",86400),c=(new DOMParser).parseFromString(c.responseText,"text/html").querySelector("#max-new-cards-per-day"),c=await Number(c.value),e+=c-t),document.createElement("div"));c.classList.add("review-progress"),c.style.position="fixed",c.style.top="0",c.style.left="0",c.style.zIndex="1000",c.style.padding="0.5rem",c.style.background="rgba(0, 0, 0, 0.5)",c.style.color="white",c.style.fontFamily="monospace",c.style.fontSize="1rem",c.style.fontWeight="bold",c.textContent=a+"/"+(a+e),document.querySelector(".review-progress")||document.body.appendChild(c)}t();let c=null;new MutationObserver(e=>{for(var a of e)a!==c&&(c=a,t())}).observe(document.body,{childList:!0,subtree:!0})}async function R(){var e,a,t,c=document.querySelector('form[action*="edit-shown-sentence"]');c&&(c=c.closest("div").querySelector("h5"))&&((e=document.createElement("button")).classList.add("sentence-clear-button"),e.title="Clear sentence via API",(a=document.createElementNS("http://www.w3.org/2000/svg","svg")).setAttribute("xmlns","http://www.w3.org/2000/svg"),a.setAttribute("viewBox","0 0 24 24"),a.classList.add("sentence-clear-button-svg"),a.innerHTML='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" fill="#2v14c0"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M14.12 10.47L12 12.59l-2.13-2.12-1.41 1.41L10.59 14l-2.12 2.12 1.41 1.41L12 15.41l2.12 2.12 1.41-1.41L13.41 14l2.12-2.12zM15.5 4l-1-1h-5l-1 1H5v2h14V4zM6 19c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V7H6v12zM8 9h8v10H8V9z"/></svg>',t=window.getComputedStyle(c),a.style.width=t.fontSize,a.style.height=t.fontSize,e.appendChild(a),e.addEventListener("click",async()=>{var e=new URL(window.location.href),a=e.searchParams.get("v"),e=e.searchParams.get("s"),t=(console.log(a,e),confirm("Are you sure you want to clear the sentence?"));t&&(await(async(e,o,n="POST")=>{f.apiKey||await s(),console.log(f.apiKey);let r={Authorization:"Bearer "+f.apiKey,"Content-Type":"application/json",Accept:"application/json"};return new Promise((t,c)=>{let d=(a=!1)=>{GM_xmlhttpRequest({method:n,url:""+y.apiBaseUrl+e,data:JSON.stringify(o),headers:r,responseType:"json",onload:async e=>{if(200===e.status)t(e.response);else if(403!==e.status||a)c(e.response);else try{await s(),r.Authorization="Bearer "+y.apiKey,d(!0)}catch(e){c(e)}},onerror:e=>c(e)})};d()})})("/set-card-sentence",{vid:Number(a),sid:Number(e),sentence:"",clear_audio:!0}),window.location.reload())}),c.appendChild(e))}async function K(){var a=document.querySelector(".plain").cloneNode(!0);if(a){a.querySelectorAll("rt").forEach(e=>e.remove());var d=a.textContent.trim(),a=document.getElementById("upload-form");if(a){let b=document.createElement("div");b.id="yomi-custom-audio";var o,n=document.createElement("h6");n.textContent="External Audio Sources",n.style.marginTop="1rem",b.appendChild(n);let t=document.createElement("div"),c=(t.textContent="Loading extra audio sources...",b.appendChild(t),a.insertAdjacentElement("afterend",b),new Map),e=0;for(o of p.advancedYomiVocabAudioServer().split(",").map(e=>e.trim()).filter(e=>0<e.length))try{var r=(await l(o.replace("{term}",d),-1,!1,!1,!1,!1,"json")).response.audioSources;r&&0<r.length&&(e+=r.length),await(async a=>{let o=document.querySelector('input[type="file"]');if(o){let e=0;if(a&&0<a.length){"Loading extra audio sources..."===t.textContent&&(t.textContent="");for(let d of a)try{e++;var n=document.createElement("div"),r=(n.style.cssText=`
                            display: flex;
                            align-items: center;
                            padding: 5px;
                        `,document.createElement("span"));r.textContent=d.name||"Audio",r.style.marginRight="10px",n.appendChild(r);let t=document.createElement("audio");var f=document.createElement("a");f.classList.add("icon-link"),f.innerHTML='<i class="ti ti-volume"></i>',f.style.cursor="pointer";let c=null;f.onclick=async e=>{e.preventDefault(),c||(c=await s(d.url),t.src=c.blobUrl),t.paused?t.play():(t.pause(),t.currentTime=0)};var i=document.createElement("a");i.classList.add("icon-link"),i.innerHTML="+",i.style.margin="0 0.5rem",i.style.cursor="pointer",i.style.scale="1.25",i.onclick=async e=>{e.preventDefault(),c||(c=await s(d.url),t.src=c.blobUrl),t.play();var e=d.url.split("/").pop()||"audio.mp3",e=new File([c.blob],e,{type:c.blob.type}),a=new DataTransfer;a.items.add(e),o.files=a.files,o.dispatchEvent(new Event("change",{bubbles:!0}))},n.appendChild(t),n.appendChild(f),n.appendChild(i),b.appendChild(n)}catch(e){console.error(`Error setting up audio source for ${d.url}:`,e)}0===e&&(t.textContent="Failed to load any audio sources.",t.style.color="#ff4444")}}})(r)}catch(e){console.error(`Error fetching audio from ${o}:`,e)}async function s(e){if(c.has(e))return c.get(e);console.log("Fetching audio blob from:",e);var a=await(await l(e,-1,!1,!1,!1,!1,"blob")).response,t=URL.createObjectURL(a);return c.set(e,{blob:a,blobUrl:t}),{blob:a,blobUrl:t}}0===e&&(t.textContent="No audio sources found.",t.style.color="#ff4444")}}}function q(){if((async()=>{let e="https://fonts.googleapis.com/css2?family=Manrope:wght@200..800&display=swap",a=await l(e,86400,!0,!1,!0,!1);if(a&&GM_addStyle(a.responseText),p.enableButtonStyling()&&r[p.translationLanguage()]["config.reviewButtonFontWeight"]){let e=await l("https://fonts.googleapis.com/css2?family=Noto+Sans+JP:wght@100..900&display=swap",86400,!0,!1,!0,!1);e&&(GM_addStyle(e.responseText),GM_addStyle(`
                    .review-button-group input[type="submit"] {
                        font-family: 'Noto Sans JP', sans-serif;
                        font-weight: ${r[p.translationLanguage()]["config.reviewButtonFontWeight"]} !important;
                    }
                `))}})(),u(),window.location.href===y.learnPageUrl){h(),g();let t=null;new MutationObserver(e=>{for(var a of e)if("childList"===a.type&&a.target.classList.contains(y.deckListClass)&&!a.target.classList.contains(y.newDeckListClass)){a!==t&&(h(),g(),t=a);break}}).observe(document.body,{childList:!0,subtree:!0})}else window.location.href.startsWith(y.reviewPageUrlPrefix)&&p.enableButtonStyling()&&(async()=>{function e(){var e;performance&&performance.timing&&(e=(e=performance.timing).loadEventEnd-e.navigationStart,GM_setValue("reviewPageLoadTime",e))}if(S(),-1===p.buttonSoundDelay()&&window.addEventListener("load",function(){setTimeout(e,0)}),p.enableButtonEffects()&&!f.cachedEffects){var a,t=[].concat(y.lottieSparkles,y.lottieSmallFireworks,y.lottieBigFireworks);console.log("Caching review button effects:",t);for(a of t)await l(a,31536e3,!0,!1,!0);f.cachedEffects=!0,GM_setValue("cachedEffects",!0)}new MutationObserver(e=>{e.forEach(e=>{"childList"===e.type&&e.addedNodes.forEach(e=>{e.nodeType===Node.ELEMENT_NODE&&(e.classList.contains("review-button-group")?S():e.querySelectorAll(y.reviewButtonSelector).forEach(k))})})}).observe(document.body,{childList:!0,subtree:!0})})();if(window.location.href.startsWith(y.reviewPageUrlPrefix)&&p.enableVerticalSentence()){function c(){if(4/3<window.innerWidth/document.querySelector(".container").clientWidth){var e=document.querySelector(".card-sentence"),a=document.querySelector(".container");e&&a&&(t=e.getBoundingClientRect(),a=a.getBoundingClientRect().bottom-t.top,e.style="",e.style.height=Math.max(a,10)+"px",e.style.right="unset",e.style.left="100%")}else{var t=document.querySelector(".sentence .icon-link"),a=document.getElementById("show-checkbox-examples-label"),e=[],c=(t&&a&&(c=D(t,a),e.push(Math.round(c)+"px")),document.querySelector(".review-button-group")),d=(t&&c&&(d=D(t,c),e.push(Math.round(d)+"px")),document.querySelector(".card-sentence"));if(!t){if(!d)return;a&&(t=O(d,a),e.push(Math.round(t)+"px")),c&&(a=O(d,c),e.push(Math.round(a)+"px"))}d&&(d.style="",d.style.height=`calc(max(10px, min(${e.join(", ")}) * 0.99)`)}}GM_addStyle(b.verticalSentence),c();let t=null;new MutationObserver(e=>{for(var a of e)a!==t&&(t=a,c())}).observe(document.body,{childList:!0,subtree:!0}),window.addEventListener("resize",c)}var e,a,t;window.location.href.startsWith(y.reviewPageUrlPrefix)&&((async()=>{let n={locked:!1,queue:[],lock:async function(){this.locked&&await new Promise(e=>this.queue.push(e)),this.locked=!0},unlock:function(){this.locked=!1;var e=this.queue.shift();e&&e()}};async function t(){if(!document.querySelector(".inserted-dropdown")){await n.lock();try{var e,a,t,c,d,o;document.querySelector(".inserted-dropdown")||(e=document.querySelector(".answer-box"))&&(a=e.querySelector('a[href*="/vocabulary/"]'))&&(t=await l(new URL(a.href,window.location.origin).href,-1),c=(new DOMParser).parseFromString(t.responseText,"text/html").querySelector(".menu .dropdown"))&&(c=c.parentElement,d=e.querySelector(".plain"))&&(c.classList.add("inserted-dropdown"),c.style.justifyContent="flex-start",c.style.fontSize="1rem",c.style.fontFamily=getComputedStyle(document.body).fontFamily,d.insertBefore(c,d.firstChild),o=c.getBoundingClientRect().width,c.style.marginRight=`-${o}px`)}finally{n.unlock()}}}await t();let c=null;new MutationObserver(async e=>{for(var a of e)a!==c&&(c=a,await t())}).observe(document.body,{childList:!0,subtree:!0})})(),GM_addStyle(b.fixCenteredAnswerBox)),window.location.href.startsWith(y.reviewPageUrlPrefix)&&d.enableProgress&&_(),window.location.href!==y.learnPageUrl&&window.location.href!=y.deckListPageUrl||A(),window.location.href===y.settingsPageUrl&&F(),p.enableReplaceKanjiStrokeOrder()&&M(),"None"!==p.translationLanguage()&&z(),p.autoExpandNavMenu()&&window.location.href.startsWith(y.reviewPageUrlPrefix)&&(e=document.getElementById("menu-btn"),a=document.querySelector(".menu"),(t=document.createElement("style")).textContent=`
        ...
        `,document.head.appendChild(t),e.checked=!0,a.offsetHeight,document.head.removeChild(t)),N(),new MutationObserver(e=>{e.forEach(e=>{"childList"===e.type&&e.addedNodes.forEach(e=>{e&&e.classList&&e.classList.contains("subsection-composed-of-kanji")?N():e&&e.querySelectorAll&&e.querySelectorAll(".subsection-composed-of-kanji").forEach(e=>{N()})})})}).observe(document.body,{childList:!0,subtree:!0}),P(),document.addEventListener("keydown",function(e){"/"===e.key&&G(e)}),p.enableSentenceBlur()&&(GM_addStyle(b.sentenceBlur),document.addEventListener("click",function(e){e.target.classList.contains("sentence-translation")&&e.target.classList.toggle("unblur")})),p.enableMonolingualMachineTranslation()&&U(),p.enableButtonSound()&&(async()=>{f.audioContext.ctx||(f.audioContext.ctx=new(window.AudioContext||window.webkitAudioContext))})(),window.location.href.startsWith(y.shownSentencePrefix)&&R(),window.location.href.startsWith(y.editAudioPrefix)&&p.advancedYomiVocabAudioServer()&&K(),f.currentVersion!==GM_info.script.version&&(GM_setValue("debug_lastVersion",f.currentVersion),f.lastVersion=f.currentVersion,GM_setValue("debug_currentVersion",GM_info.script.version),f.currentVersion=GM_info.script.version),document.dispatchEvent(new CustomEvent(GM_info.script.name+"-initialized"))}try{u()}catch(e){}if("loading"===document.readyState)document.addEventListener("DOMContentLoaded",q);else try{q()}catch(e){}})();
