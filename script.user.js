...
`});a=c.querySelector(".subsection-label");a&&((e=document.createElement("button")).classList.add("kanji-copy-button"),(o=document.createElementNS("http://www.w3.org/2000/svg","svg")).setAttribute("xmlns","http://www.w3.org/2000/svg"),o.setAttribute("viewBox","0 0 24 24"),o.classList.add("kanji-copy-button-svg"),o.innerHTML='<path d="M0 0h24v24H0V0z" fill="none"/><path d="M16 1H4c-1.1 0-2 .9-2 2v14h2V3h12V1zm3 4H8c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h11c1.1 0 2-.9 2-2V7c0-1.1-.9-2-2-2zm0 16H8V7h11v14z"/>',c=window.getComputedStyle(a),o.style.width=c.fontSize,o.style.height=c.fontSize,e.appendChild(o),e.addEventListener("click",()=>{GM_setClipboard(n.trim())}),document.dispatchEvent(new CustomEvent("kanjiComponents",{detail:{componentString:n.trim()}})),a.appendChild(e))}}}}}}function q(){let a=(()=>{let t=new Map;return function(a){document.querySelectorAll(".deck").forEach(e=>{e.querySelectorAll('input[type="hidden"][name="delta"]').forEach(e=>{a?(t.set(e,e.value),e.value*=9999):e.value=t.get(e)||e.value})})}})();document.addEventListener("keydown",function(e){"Shift"===e.key&&a(!0)}),document.addEventListener("keyup",function(e){"Shift"===e.key&&a(!1)})}function _(){document.addEventListener("keydown",function(e){var a,t;"Enter"===e.key&&e.ctrlKey&&(a=(e=e).target,t=a.closest("form"))&&a.matches("input")&&["text","search"].includes(a.type)&&(e.preventDefault(),(a=t.cloneNode(!0)).target="_blank",document.body.appendChild(a),a.submit(),document.body.removeChild(a),window.focus())})}function O(){let e=document.querySelector(".injected-search-overlay");var a;e&&(a=e.firstElementChild,u.searchBarOverlayTransition()?(e.style.backgroundColor="rgba(0, 0, 0, 0)",e.style.backdropFilter="blur(0px)",a.style.transform="scale(0.75)",a.style.opacity="0",setTimeout(()=>{document.body.removeChild(e)},y.searchOverlayTransitionDuration)):document.body.removeChild(e))}async function G(){var t=document.querySelector(".injected-search-overlay");if(!t){t=await h("https://jpdb.io/",86400,!0),t=(new DOMParser).parseFromString(t.responseText,"text/html").querySelector('form[action="/search#a"]');if(t){t=t.cloneNode(!0);let a=document.createElement("div"),e=(a.classList.add("injected-search-overlay"),a.style.cssText=`
        ...
        `,document.createElement("div"));u.searchBarOverlayTransition()&&(e.style.cssText=`
            ...
            min-width: 40vw;
            max-width: 80vw;
        `,u.searchBarOverlayTransition()&&setTimeout(()=>{a.style.backgroundColor="rgba(0, 0, 0, 0.7)",a.style.backdropFilter="blur(1px)",e.style.transform="scale(1)",e.style.opacity="1"},10),a.addEventListener("keydown",function(e){["Escape","Enter","/"].includes(e.key)||e.ctrlKey||e.altKey||e.metaKey||e.stopPropagation(),"Escape"===e.key&&O()}),document.addEventListener("keydown",function(e){"Escape"===e.key&&O()},{once:!0}),a.addEventListener("click",e=>{e.target===a&&O()}),a}}}function z(e){var a,t;a=document.activeElement,t=a.isContentEditable,a!==document.body&&(t||["text","search"].includes(a.type))||(e.preventDefault(),(t=document.querySelector('input[type="search"]'))?t.focus():G())}function F(){let o=document.querySelector('form[action="/settings"]');if(o){var e=o.querySelectorAll("div"),e=Array.from(e).reverse().find(e=>e.querySelector('input[type="submit"]'));if(e){let c="";for(let n of Object.values(u)){let e=0,a=n.getDependency(),t=a;for(;null!==a;)t=a,e+=1.5,a=a.getDependency();var d=e+"rem",r=!(null===t||t()&&t()===n.getDependency()()&&n.getDependency()())?' class="hidden"':"";n.getPossibleValues()?c+=`
...
${n.getLongDescription()}
                ...
                `;e.previousSibling.insertAdjacentHTML("beforebegin",l),document.getElementById("build-kanji-cache").addEventListener("click",function(e){e.preventDefault(),T()});let a=document.getElementById("reset-settings"),t=(a.addEventListener("click",function(e){e.preventDefault();GM_listValues().forEach(e=>{GM_deleteValue(e)});e=0===GM_listValues().length;a.parentElement.parentElement.querySelector("p").textContent=e?"Settings reset successfully.":"Settings reset failed.",o.submit()}),document.getElementById("reset-kanji-cache"));t.addEventListener("click",function(e){e.preventDefault(),new Promise((a,t)=>{var e=indexedDB.deleteDatabase(y.indexedDBName);e.onerror=e=>{console.error(`Error deleting database ${y.indexedDBName}:`,e.target.error),t(e.target.error)},e.onsuccess=e=>{console.log(`Database ${y.indexedDBName} successfully deleted`),a()},e.onblocked=e=>{console.warn(`Database ${y.indexedDBName} deletion blocked. Please close all other tabs with this site open.`)}}),t.parentElement.parentElement.querySelector("p").textContent="Kanji cache reset.",o.submit()});let n=new Map;for(i of Object.values(u))i.getDependency()&&n.set(i.getName(),function e(a,t=[]){a=a.getDependency();return a?(t.unshift(a),e(a,t)):t}(i));for([f,s]of n)for(let t of s){var b=o.querySelector(`[name="${t.getName()}"]`);b&&!b.dataset.hasChangeListener&&(b.addEventListener("change",function(){for(var[e,a]of n)a.includes(t)&&(e=o.querySelector(`[name="${e}"]`),a=a.some(e=>{e=o.querySelector(`[name="${e.getName()}"]`);return e&&!e.checked}),("checkbox"===e.type?e.parentElement:e).parentElement.classList.toggle("hidden",a),e.dispatchEvent(new Event("change")))}),b.dataset.hasChangeListener="true")}o.addEventListener("submit",function(e){e.preventDefault();for(var a of Object.values(u)){var t=o.querySelector(`input[name="${a.getName()}"]`)||o.querySelector(`textarea[name="${a.getName()}"]`),n=o.querySelector(`select[name="${a.getName()}"]`);t?"boolean"==typeof a()?a(t.checked):"number"==typeof a()?a(Number(t.value)):a(t.value):n&&a(n.value)}this.submit()})}}}async function K(){let a=!1;function c(e,n){var a=u.translationLanguage();var t,c,o,d,r=(t=(t=e)&&"string"==typeof t?(t=t.replace(/<script[^>]*>([\S\s]*?)<\/script>/gim,"")).replace(/<\/?\w(?:[^"'>]|"[^"]*"|'[^']*')*>/gim,""):t).normalize("NFKC"),i=(t=r,i=n,"None"!==(c=a)&&s[c]&&(c=s[c][t.trim()])?"string"==typeof c?c:"object"==typeof c&&c.text&&(!c.blacklist||!i.matches(c.blacklist))&&(!c.whitelist||i.matches(c.whitelist))?c.text:t:t);if(i!==r)return i;for([o,d]of Object.entries(s[a]))if(o.startsWith("/")&&o.endsWith("/")){var f=new RegExp(o.slice(1,-1));let t=r.trim().match(f);if(t){f="object"==typeof d?d.text:d;if("object"==typeof d){if(d.blacklist&&n.matches(d.blacklist))continue;if(d.whitelist&&!n.matches(d.whitelist))continue}let a=f;for(let e=0;e<t.length;e++)a=a.replace(new RegExp(`\\{${e}\\}`,"g"),()=>t[e]||"");return a}}return e}function t(){var e;a=!0;for(e of document.getElementsByTagName("*"))(n=>{if(n.nodeType===Node.ELEMENT_NODE&&!n.classList.contains("translated")){let t=!1;n.childNodes.forEach(e=>{var a;e.nodeType===Node.TEXT_NODE&&(a=e.textContent.trim())&&a!==(a=c(a,n))&&(e.textContent=a,t=!0)});var e;["placeholder","value","title","alt","aria-label"].forEach(e=>{var a;n.hasAttribute(e)&&(a=n.getAttribute(e))!==(a=c(a))&&(n.setAttribute(e,a),t=!0)}),"INPUT"===n.tagName&&"submit"===n.type&&(e=n.value)!==(e=c(e))&&(n.value=e,t=!0),"META"===n.tagName&&"description"===n.name&&(e=n.content)!==(e=c(e))&&(n.content=e,t=!0),t&&(n.setAttribute("lang",u.translationLanguage()),n.classList.add("translated"))}})(e);a=!1}new MutationObserver(e=>{a||(a=!0,e.forEach(e=>{"childList"===e.type?e.addedNodes.forEach(e=>{e.nodeType===Node.ELEMENT_NODE&&t()}):"attributes"===e.type&&t()}),a=!1)}).observe(document.body,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["placeholder","value","title","alt","aria-label"]}),t()}function R(){async function r(e,a=604800){var e=await h(`https://jpdb.io/search?q=${encodeURIComponent(e)}&lang=english#a`,a,!1,!1,!0,!1),t=(new DOMParser).parseFromString(e.responseText,"text/html").querySelector("#machine-translation");return t.classList.contains("translation-in-progress")?{success:!0,translation:(await h("https://jpdb.io/translation?id="+e.responseText.match(/translation\?id=(\d+)/)[1],a,!1,!1,!0,!1)).responseText.trim()}:t?{success:!0,translation:t.textContent.trim()}:{success:!1,translation:""}}function i(e){var e=e.cloneNode(!0),a=document.createElement("div");return a.appendChild(e),a.querySelectorAll("ruby rt").forEach(e=>e.remove()),a.innerText.replace(/<br>/g,"\n").replace(/\n/g," ").replace(/<[^>]*>/g,"").trim()}function a(){document.querySelectorAll(".used-in").forEach(e=>{let c=e.querySelector(".jp"),a=e.querySelector(".en");if(c&&!a){let n=document.createElement("div");n.classList.add("en"),n.classList.add("pending-translation"),n.textContent="Click to translate",e.appendChild(n);const o=604800;n.addEventListener("click",async function e(){var a=i(c),{success:a,translation:t}=(n.textContent="Translating...",await r(a,o));a?(n.textContent=t,n.classList.remove("pending-translation"),n.removeEventListener("click",e)):(n.textContent="Translation failed. Click to try again.",o=0)})}});let o=document.querySelector(".card-sentence");var e=document.querySelector(".review-reveal"),a=o?.parentElement?.querySelector(".sentence-translation");if(o&&!a&&e){let c=o.querySelector(".sentence");o.insertAdjacentHTML("afterend",'<div style="display: flex;justify-content: center;"><div class="sentence-translation" style="">Click to translate</div></div>');const d=604800;o.nextElementSibling.querySelector(".sentence-translation").addEventListener("click",async function e(){var a=i(c),t=o.nextElementSibling.querySelector(".sentence-translation"),{success:a,translation:n}=(t.textContent="Translating...",await r(a));a?(t.textContent=n,t.classList.remove("pending-translation"),t.removeEventListener("click",e)):(t.textContent="Translation failed. Click to try again.",d=0)})}}new MutationObserver(e=>{e.forEach(e=>{"childList"===e.type&&e.addedNodes.forEach(e=>{e.nodeType===Node.ELEMENT_NODE&&a()})})}).observe(document.body,{childList:!0,subtree:!0}),a()}function D(e,a){e=e.getBoundingClientRect();return a.getBoundingClientRect().top-e.bottom}function V(e,a){e=e.getBoundingClientRect();return a.getBoundingClientRect().top-e.top}async function U(){async function c(){let e=null;e=document.querySelector(".review-reveal")?await h("https://jpdb.io/stats",9999):await h("https://jpdb.io/stats",3);var a=(new DOMParser).parseFromString(e.responseText,"text/html").querySelectorAll("script");let t=null;if(a.forEach(e=>{e.textContent.includes('document.getElementById("chart")')&&(t=e)}),t){let e=t.textContent.match(new RegExp(/var\s?data\s?=\s?({\s?.+?\s?});/))[1];e=(e=e.replace(/(['"])?([a-zA-Z0-9_]+)(['"])?:/g,'"$2": ')).replace(/,(\s*[}\]])/g,"$1");var a=JSON.parse(e),n=a.datasets.find(e=>e.label.toLowerCase().includes("old")&&e.label.toLowerCase().includes("failed")),c=a.datasets.find(e=>e.label.toLowerCase().includes("old")&&e.label.toLowerCase().includes("passed")),a=a.datasets.find(e=>e.label.toLowerCase().includes("new"));return{oldCardsCount:n.data[n.data.length-1]+c.data[c.data.length-1],newCardsCount:a.data[a.data.length-1]}}return{oldCardsCount:0,newCardsCount:0}}async function t(){let e=(a=document.querySelector('.nav-item[href*="/learn"]').querySelector("span"))&&"red"===getComputedStyle(a).color||"rgb(255, 0, 0)"===getComputedStyle(a).color?Number(a.textContent):0;var{oldCardsCount:a,newCardsCount:t}=await c(),a=a+t,n=(0<t&&(n=await h("https://jpdb.io/settings",86400),n=(new DOMParser).parseFromString(n.responseText,"text/html").querySelector("#max-new-cards-per-day"),n=await Number(n.value),e+=n-t),document.createElement("div"));n.classList.add("review-progress"),n.style.position="fixed",n.style.top="0",n.style.left="0",n.style.zIndex="1000",n.style.padding="0.5rem",n.style.background="rgba(0, 0, 0, 0.5)",n.style.color="white",n.style.fontFamily="monospace",n.style.fontSize="1rem",n.style.fontWeight="bold",n.textContent=a+"/"+(a+e),document.querySelector(".review-progress")||document.body.appendChild(n)}t();let n=null;new MutationObserver(e=>{for(var a of e)a!==n&&(n=a,t())}).observe(document.body,{childList:!0,subtree:!0})}async function I(){var a=document.querySelector(".plain").cloneNode(!0);if(a){a.querySelectorAll("rt").forEach(e=>e.remove());var c=a.textContent.trim(),a=document.getElementById("upload-form");if(a){let s=document.createElement("div");s.id="yomi-custom-audio";var o,d=document.createElement("h6");d.textContent="External Audio Sources",d.style.marginTop="1rem",s.appendChild(d);let t=document.createElement("div"),n=(t.textContent="Loading extra audio sources...",s.appendChild(t),a.insertAdjacentElement("afterend",s),new Map),e=0;for(o of u.advancedYomiVocabAudioServer().split(",").map(e=>e.trim()).filter(e=>0<e.length))try{var r=(await h(o.replace("{term}",c),-1,!1,!1,!1,!1,"json")).response.audioSources;r&&0<r.length&&(e+=r.length),await(async a=>{let o=document.querySelector('input[type="file"]');if(o){let e=0;if(a&&0<a.length){"Loading extra audio sources..."===t.textContent&&(t.textContent="");for(let c of a)try{e++;var d=document.createElement("div"),r=(d.style.cssText=`
                            display: flex;
                            align-items: center;
                            padding: 5px;
                        `,document.createElement("span"));r.textContent=c.name||"Audio",r.style.marginRight="10px",d.appendChild(r);let t=document.createElement("audio");var i=document.createElement("a");i.classList.add("icon-link"),i.innerHTML='<i class="ti ti-volume"></i>',i.style.cursor="pointer";let n=null;i.onclick=async e=>{e.preventDefault(),n||(n=await l(c.url),t.src=n.blobUrl),t.paused?t.play():(t.pause(),t.currentTime=0)};var f=document.createElement("a");f.classList.add("icon-link"),f.innerHTML="+",f.style.margin="0 0.5rem",f.style.cursor="pointer",f.style.scale="1.25",f.onclick=async e=>{e.preventDefault(),n||(n=await l(c.url),t.src=n.blobUrl),t.play();var e=c.url.split("/").pop()||"audio.mp3",e=new File([n.blob],e,{type:n.blob.type}),a=new DataTransfer;a.items.add(e),o.files=a.files,o.dispatchEvent(new Event("change",{bubbles:!0}))},d.appendChild(t),d.appendChild(i),d.appendChild(f),s.appendChild(d)}catch(e){console.error(`Error setting up audio source for ${c.url}:`,e)}0===e&&(t.textContent="Failed to load any audio sources.",t.style.color="#ff4444")}}})(r)}catch(e){console.error(`Error fetching audio from ${o}:`,e)}async function l(e){if(n.has(e))return n.get(e);console.log("Fetching audio blob from:",e);var a=await(await h(e,-1,!1,!1,!1,!1,"blob")).response,t=URL.createObjectURL(a);return n.set(e,{blob:a,blobUrl:t}),{blob:a,blobUrl:t}}0===e&&(t.textContent="No audio sources found.",t.style.color="#ff4444")}}}function H(){function f(e,a){for(var t in a)e[t]?e[t].count+=a[t].count:e[t]=a[t];return e}function s(e){var e=Object.values(e),a=e.reduce((e,a)=>e+a.count,0),t=e.filter(e=>!(e.card_state||[]).includes("blacklisted")).reduce((e,a)=>e+a.count,0),n=e.filter(e=>(e.card_state||[]).includes("known")||(e.card_state||[]).includes("never-forget")||(e.card_state||[]).includes("blacklisted")).reduce((e,a)=>e+a.count,0),n=0<a?n/a:0,c=e.filter(e=>(e.card_state||[]).includes("known")||(e.card_state||[]).includes("never-forget")).reduce((e,a)=>e+a.count,0);return{total_occurrences:a,total_occurrences_excluding_blacklist:t,comprehension:n,comprehension_excluding_blacklist:0<t?c/t:0,unique_words:e.length,unique_words_excluding_blacklist:e.filter(e=>!(e.card_state||[]).includes("blacklisted")).length}}async function l(e){let t=[],n=[],c=0,a=(e.forEach(e=>{var a=e.length;3e3<c+a&&(t.push(n),n=[],c=0),n.push(e),c+=a}),n.length&&t.push(n),{}),o=t.length;for(var d of t){d=await(async e=>{var a,t,n=(e=await b("/parse",{text:e.join("\n"),token_fields:["vocabulary_index"],vocabulary_fields:["vid","sid","rid","spelling","reading","card_level","card_state"]})).vocabulary,c={};for(a of n)c[a[0]+"-"+a[1]]={spelling:a[3],reading:a[4],card_level:a[5],card_state:a[6],count:0};for(t of e.tokens){var o=n[t[0]];c[o[0]+"-"+o[1]].count++}return c})(d);a=f(a,d),0<--o&&await new Promise(e=>setTimeout(e,1e3))}return a}async function o(e){var a,t,n=new URL(window.location.href);n.pathname+="/results",window.history.pushState({},"",n);let c=document.querySelector(".container");function o(e,a){"Analyzing..."===c.innerHTML&&(c.innerHTML="");var t=document.createElement("h4"),e=(t.textContent=e,c.appendChild(t),document.createElement("div"));e.style.marginBottom="1rem",e.textContent=`Comprehension: ${Math.round(100*a.comprehension_excluding_blacklist)}%`,c.appendChild(e)}c&&(c.innerHTML="Analyzing..."),e.sort((e,a)=>e[0].localeCompare(a[0]));let d={},r=e.length;for([a,t]of e){var i=await l((e=>{var a,t=new RegExp("^♪♪(.|\\n)*|(.|\\n)*♪♪$|^([(（]([^()（）]|(([(（][^()（）]+[)）])))+[)）])$|^\\[.*\\]$|^♪〜.*|^♪♪.*|.*〜♪|.*～♪|^♪～.*$|\\([^)]*\\)|（.*?）|^♬～.*|《[^》]*》|[（）＜＞]|[→➡]+|♬～|♬♬|～♬|♪～|～♪|♪♪|♪♪～|～♪♪|♬♬～|～♬♬|♪〜|〜♪"),n=[];for(a of e)(a=(a=a.replace(/\\N/g,"\n")).replace(t,"").trim())&&n.push(a);return n})((i=t,/\d{2}:\d{2}:\d{2},\d{3} --> \d{2}:\d{2}:\d{2},\d{3}/.test(i)?i.trim().split("\n\n").map(e=>e.split("\n").slice(2).join(" ").trim()).filter(e=>0<e.length):i.split("\n").map(e=>e.trim()).filter(e=>0<e.length)))),i=(d=f(d,i),s(i));o(a,i),0<--r&&await new Promise(e=>setTimeout(e,1e3))}1<e.length&&o("Combined",s(d))}var e=document.querySelector(".container");if(e){document.title="Custom Comprehension Analyzer",e.innerHTML="";var n=document.createElement("h4"),n=(n.textContent="Custom Comprehension Analyzer",e.appendChild(n),document.createElement("p")),n=(n.textContent=`This is a custom comprehension analyzer injected by ${GM_info.script.name}.`,e.appendChild(n),document.createElement("p")),n=(n.textContent="Input raw text or the contents of an .srt file into the text box or using the file input below.",e.appendChild(n),document.createElement("form")),n=(n.style.display="inline",n.innerHTML=`
        ...
        `,n.addEventListener("submit",async e=>{e.preventDefault();e=e.target.text.value;console.log(e),o([["Text",e]])}),e.appendChild(n),document.createElement("form")),e=(n.style.display="inline",n.innerHTML=`
        ...
        `,document.head.appendChild(t),e.checked=!0,a.offsetHeight,document.head.removeChild(t)),A(),new MutationObserver(e=>{e.forEach(e=>{"childList"===e.type&&e.addedNodes.forEach(e=>{e&&e.classList&&e.classList.contains("subsection-composed-of-kanji")?A():e&&e.querySelectorAll&&e.querySelectorAll(".subsection-composed-of-kanji").forEach(e=>{A()})})})}).observe(document.body,{childList:!0,subtree:!0}),_(),document.addEventListener("keydown",function(e){"/"===e.key&&z(e)}),u.enableSentenceBlur()&&(GM_addStyle(p.sentenceBlur),document.addEventListener("click",function(e){e.target.classList.contains("sentence-translation")&&e.target.classList.toggle("unblur")})),u.enableMonolingualMachineTranslation()&&R(),u.enableButtonSound()&&(async()=>{i.audioContext.ctx||(i.audioContext.ctx=new(window.AudioContext||window.webkitAudioContext))})(),window.location.href.startsWith(y.shownSentencePrefix)&&(async()=>{var e,a,t,n=document.querySelector('form[action*="edit-shown-sentence"]');n&&(n=n.closest("div").querySelector("h5"))&&((e=document.createElement("button")).classList.add("sentence-clear-button"),e.title="Clear sentence via API",(a=document.createElementNS("http://www.w3.org/2000/svg","svg")).setAttribute("xmlns","http://www.w3.org/2000/svg"),a.setAttribute("viewBox","0 0 24 24"),a.classList.add("sentence-clear-button-svg"),a.innerHTML='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" fill="#2v14c0"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M14.12 10.47L12 12.59l-2.13-2.12-1.41 1.41L10.59 14l-2.12 2.12 1.41 1.41L12 15.41l2.12 2.12 1.41-1.41L13.41 14l2.12-2.12zM15.5 4l-1-1h-5l-1 1H5v2h14V4zM6 19c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V7H6v12zM8 9h8v10H8V9z"/></svg>',t=window.getComputedStyle(n),a.style.width=t.fontSize,a.style.height=t.fontSize,e.appendChild(a),e.addEventListener("click",async()=>{var e=new URL(window.location.href),a=e.searchParams.get("v"),e=e.searchParams.get("s"),t=(console.log(a,e),confirm("Are you sure you want to clear the sentence?"));t&&(await b("/set-card-sentence",{vid:Number(a),sid:Number(e),sentence:"",clear_audio:!0}),window.location.reload())}),n.appendChild(e))})(),window.location.href.startsWith(y.editAudioPrefix)&&u.advancedYomiVocabAudioServer()&&I(),window.location.href===y.customComprehensionAnalyzerUrl&&H(),i.currentVersion!==GM_info.script.version&&(GM_setValue("debug_lastVersion",i.currentVersion),i.lastVersion=i.currentVersion,GM_setValue("debug_currentVersion",GM_info.script.version),i.currentVersion=GM_info.script.version),document.dispatchEvent(new CustomEvent(GM_info.script.name+"-initialized"))}try{g()}catch(e){}if("loading"===document.readyState)document.addEventListener("DOMContentLoaded",N);else try{N()}catch(e){}}();
