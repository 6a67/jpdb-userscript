...
// @updateURL https://raw.githubusercontent.com/6a67/jpdb-userscript/minified/script.user.js
// ==/UserScript==
!function(){class e{constructor(e,a,t,n={}){var{longDescription:n="",possibleValues:o=null,minVal:c=1,maxVal:r=99999,dependency:d=null,largeTextField:i=!1,colorPicker:f=!1,infoOnly:s=!1}=n;return this.name=e,this.defaultValue=a,this.shortDescription=t,this.longDescription=n,this.possibleValues=o,this.minVal=c,this.maxVal=r,this.dependency=d,this.largeTextField=i,this.colorPicker=f,this.infoOnly=s,this.value=s?a:this.validateValue(GM_getValue(e,a)),this.createSettingFunction()}getValue=()=>this.value;getName=()=>this.name;getShortDescription=()=>this.shortDescription;getLongDescription=()=>this.longDescription;getPossibleValues=()=>this.possibleValues;getMinVal=()=>this.minVal;getMaxVal=()=>this.maxVal;getDependency=()=>this.dependency;getLargeTextField=()=>this.largeTextField;getColorPicker=()=>this.colorPicker;getInfoOnly=()=>this.infoOnly;validateValue(e){return this.possibleValues&&!this.possibleValues.includes(e)||"number"==typeof e&&(e<this.minVal||e>this.maxVal)?(console.warn(`Invalid value for ${this.name}. Using default value.`),this.defaultValue):e}setValue(e){this.infoOnly?console.warn(`Attempted to set value for info-only setting ${this.name}.`):(e=this.validateValue(e))!==this.value&&(this.value=e,GM_setValue(this.name,e))}createSettingFunction(){var e=(...e)=>(0<e.length&&this.setValue(e[0]),this.getValue());return Object.assign(e,{getValue:this.getValue,setValue:this.setValue.bind(this),getName:this.getName,getShortDescription:this.getShortDescription,getLongDescription:this.getLongDescription,getPossibleValues:this.getPossibleValues,getMinVal:this.getMinVal,getMaxVal:this.getMaxVal,getDependency:this.getDependency,getLargeTextField:this.getLargeTextField,getColorPicker:this.getColorPicker,getInfoOnly:this.getInfoOnly}),e}}let i={currentlyBuildingKanjiCache:!1,cachedEffects:GM_getValue("cachedEffects",!1),warmingEffectsPromise:null,revealEffectPlayed:!1,audioContext:{ctx:null,src:null,gain:null},apiKey:GM_getValue("apiKey",""),currentVersion:GM_getValue("debug_currentVersion",""),previousVersion:GM_getValue("debug_previousVersion",""),lastChangelogCheck:GM_getValue("lastChangelogCheck",0),lastChangelogDate:GM_getValue("lastChangelogDate",0)},f={},y={apiBaseUrl:"https://jpdb.io/api/v1",learnPageUrl:"https://jpdb.io/learn",deckListPageUrl:"https://jpdb.io/deck-list",reviewPageUrlPrefix:"https://jpdb.io/review",settingsPageUrl:"https://jpdb.io/settings",shownSentencePrefix:"https://jpdb.io/edit-shown-sentence",editAudioPrefix:"https://jpdb.io/edit-audio",customComprehensionAnalyzerUrl:"https://jpdb.io/custom-comprehension-analyzer",deckListClass:"deck-list",deckListSelector:"div.deck-list",newDeckListClass:"injected-deck-list",newDeckListSelector:"div.injected-deck-list",deckListLinkSelector:'a[href="/deck-list"]',reviewButtonSelector:'.review-button-group input[type="submit"]',strokeOrderHost:"https://github.com",strokeOrderRawHost:"https://raw.githubusercontent.com",strokeOrderRepo:"KanjiVG/kanjivg",strokeOrderFolder:"kanji",strokeOrderBranch:"master",kanjiSvgSelector:".kanji svg",kanjiPlainSelector:".kanji.plain",searchOverlayTransitionDuration:200,cachePrefix:"cache_",indexedDBName:"HttpRequestCache",indexedDBStoreName:"responses",soundUrlFail:"https://d35aaqx5ub95lt.cloudfront.net/sounds/f0b6ab4396d5891241ef4ca73b4de13a.mp3",soundUrlHard:"https://d35aaqx5ub95lt.cloudfront.net/sounds/a28ff0a501ef5f33ca78c0afc45ee53e.mp3",soundUrlOkay:"https://d35aaqx5ub95lt.cloudfront.net/sounds/37d8f0b39dcfe63872192c89653a93f6.mp3",soundUrlEasy:"https://d35aaqx5ub95lt.cloudfront.net/sounds/2aae0ea735c8e9ed884107d6f0a09e35.mp3",soundUrlReveal:"https://files.catbox.moe/hzxzzb.ogg",lottieSparkles:["https://d35aaqx5ub95lt.cloudfront.net/lottie/e13df96082d0e4dbc6d78b6f5346e2a2.json","https://d35aaqx5ub95lt.cloudfront.net/lottie/b50a27f803ddd071fdbd83af2fc05c8a.json"],lottieSmallFireworks:["https://files.catbox.moe/1ggh8q.json","https://files.catbox.moe/5t0xm4.json"],lottieBigFireworks:["https://files.catbox.moe/cb35i9.json"],lottieExplosions:["https://d35aaqx5ub95lt.cloudfront.net/lottie/2a62162ea93d55dee67189cc47bd98ab.json"]},c={enableCacheLogs:!1,enableProgress:GM_getValue("progress_enableProgress",!1)},s={None:{},ja:{Kanji:"漢字","Type a word, a kanji, or a sentence":"単語、漢字、または文章を入力してください",Settings:"設定",Logout:"ログアウト",Stats:"統計",Vocabulary:"単語",Component:"部品","Show answer":"答えを表示","✘ Nothing":"✘ 全然","✘ Something":"✘ 何か","✔ Hard":"✔ 難しい","✔ Okay":"✔ 大丈夫","✔ Easy":"✔ 簡単",Blacklist:"ブラックリスト","I'll never forget":"絶対に忘れない","I know this, will never forget":"完全に覚えている、絶対に忘れない","I know this, but may forget":"知っているが、忘れる可能性がある","I don't know this":"これは知らない",[String.raw`/^Words \((.*?)\)$/`]:"単語（{1}）",[String.raw`/^Kanji \((.*?)\)$/`]:"漢字（{1}）","Learn (":"学習 (","Built-in decks":"内蔵デッキ","Start reviewing":"復習を始める","Welcome back!":"お帰りなさい！",Quiz:"クイズ",Leaderboard:"リーダーボード",Meanings:{text:"意味",blacklist:"input"},"config.reviewButtonFontWeight":"500","Sort by":{text:"並び替え",whitelist:"fieldset > legend"},"/^Name(.*?)$/":{text:"名前{1}",whitelist:".sorting-header a"},"/^Characters(.*?)$/":{text:"文字数{1}",whitelist:".sorting-header a"},"/^Difficulty(.*?)$/":{text:"難易度{1}",whitelist:".sorting-header a"},"/^Word count \\(known %\\)(.*?)$/":{text:"単語数（習得済み％）{1}",whitelist:".sorting-header a"},"/^Word count(.*?)$/":{text:"単語数{1}",whitelist:".sorting-header a"},"/^Unique vocabulary \\(known %\\)(.*?)$/":{text:"語彙の種類（習得済み％）{1}",whitelist:".sorting-header a"},"/^Unique vocabulary(.*?)$/":{text:"語彙の種類{1}",whitelist:".sorting-header a"},"/^Unique kanji(.*?)$/":{text:"漢字の種類{1}",whitelist:".sorting-header a"},"/^User rating(.*?)$/":{text:"ユーザー評価{1}",whitelist:".sorting-header a"},"Show only":{text:"絞り込み",whitelist:"fieldset > legend"},Anime:{text:"アニメ",whitelist:".sorting-header a"},"Live action":{text:"ドラマ",whitelist:".sorting-header a"},"Visual novels":{text:"ビジュアルノベル",whitelist:".sorting-header a"},"Video games":{text:"ビデオゲーム",whitelist:".sorting-header a"},Novels:{text:"小説",whitelist:".sorting-header a"},"Web novels":{text:"ウェブ小説",whitelist:".sorting-header a"},"Books (non-fiction)":{text:"本（ノンフィクション）",whitelist:".sorting-header a"},Textbooks:{text:"教科書",whitelist:".sorting-header a"},"YouTube videos":{text:"YouTube動画",whitelist:".sorting-header a"},"Audio works":{text:"音声作品",whitelist:".sorting-header a"},"Aozora Bunko":{text:"青空文庫",whitelist:".sorting-header a"}}};var a,t,n;(a={}).enableButtonStyling=new e("enableButtonStyling",!0,"Button styling",{longDescription:"Apply custom styles to review page buttons."}),a.enableButtonEffects=new e("enableButtonEffects",!0,"Button effects",{dependency:a.enableButtonStyling}),a.enableButtonSound=new e("enableButtonSound",!0,"Button sounds",{dependency:a.enableButtonStyling}),a.buttonSoundVolume=new e("buttonSoundVolume",.7,"Button sound volume",{minVal:0,maxVal:1,dependency:a.enableButtonSound}),a.buttonSoundDelay=new e("buttonSoundDelay",-1,"Button sound delay",{longDescription:"Set delay before redirect after sound plays. -1 for auto-detect, large negative to disable.",minVal:-99999,maxVal:99999,dependency:a.enableButtonSound}),a.enableReplaceKanjiStrokeOrder=new e("enableReplaceKanjiStrokeOrder",!0,"KanjiVG stroke order"),a.useFontInsteadOfSvg=new e("useFontInsteadOfSvg",!1,"Font-based stroke order",{longDescription:"Use font instead of SVG for stroke order.",dependency:a.enableReplaceKanjiStrokeOrder}),a.enableSentenceBlur=new e("enableSentenceBlur",!0,"Blur translations",{longDescription:"Blur sentence translations on card back. Click to toggle."}),a.enableVerticalSentence=new e("enableVerticalSentence",!1,"Vertical sentences on review cards"),a.searchBarOverlayTransition=new e("searchBarOverlayTransition",!1,"Search overlay animation"),a.alwaysShowKanjiGrid=new e("alwaysShowKanjiGrid",!0,"Always show kanji grid"),a.autoExpandNavMenu=new e("autoExpandNavMenu",!1,"Auto-expand the navigation menu on review page"),a.hideLogoutButton=new e("hideLogoutButton",!1,"Hide Logout Button",{longDescription:'Hide the logout button in the navigation menu. You can logout by clicking <a href="/logout">here</a>.'}),a.showHiddenVocabularyOnBack=new e("showHiddenVocabularyOnBack",!1,"Show hidden vocabulary on the back of the card",{longDescription:'If "Enlarge the example sentence and do not show the reviewed word by itself on a separate line (when possible)" is enabled, this setting will show the hidden vocabulary on the back of the card.'}),a.enableMonolingualMachineTranslation=new e("enableMonolingualMachineTranslation",!0,"Machine translation for monolingual sentences",{longDescription:"Shows a placeholder sentence that can be clicked to translate the sentence using JPDBs machine translation."}),a.translationLanguage=new e("translation","None","Partial translation",{possibleValues:Object.keys(s)}),a.customComprehensionAnalyzerInfo=new e("customComprehensionAnalyzerInfo","",`Click <a href="${y.customComprehensionAnalyzerUrl}">here</a> to open the custom comprehension analyzer.`,{infoOnly:!0}),a.showAdvancedSettings=new e("showAdvancedSettings",!1,"Show advanced settings"),a.advancedShortButtonVibration=new e("advancedShortButtonVibration",!1,"Short button vibration",{longDescription:"Vibrate the device for a short duration when a positive button is pressed. Only works if button styling is enabled.",dependency:a.showAdvancedSettings}),a.advancedStaticAnswerButtonsOnSmallScreens=new e("advancedStaticAnswerButtonsOnSmallScreens",!1,"Static answer buttons on small screens",{longDescription:"Move the answer buttons to the bottom of the page on small screens instead of floating.",dependency:a.showAdvancedSettings}),a.advancedTransparentBackgroundAnswerButtons=new e("advancedTransparentBackgroundAnswerButtons",!1,"Transparent answer buttons background on small screens",{longDescription:"Make the answer buttons background transparent on small screens.",dependency:a.showAdvancedSettings}),a.advancedPreferKanjiStrokeOrderSVGVariants=new e("advancedPreferKanjiStrokeOrderSVGVariants","","Prefer a given list of variants for KanjiVG stroke order over the default one",{longDescription:'Only applies, when SVG stroke order is enabled. Provide a comma-separated list of variants to prefer over the default KanjiVG stroke order. E.g. "Insatsu, Kaisho" checks first for the Insatsu variant, then the Kaisho variant, and finally the default one.<br>The list is case-sensitive and the default variant is always checked last. (Length of list + 1) is the number of requests that will be made for each Kanji. It is advised to rebuild the Kanji cache after changing this setting.<br>Read more about the variants <a href="https://kanjivg.tagaini.net/variants.html">here</a>.',largeTextField:!0,dependency:a.showAdvancedSettings}),a.advancedYomiVocabAudioServer=new e("advancedYomiVocabAudioServer","","Yomi vocab audio server (experimental)",{longDescription:"A comma-separated list of URLs with '{term}' as placeholder (e.g. 'http://localhost:5050/?term={term}') that can be used to set custom audio for vocabularies.",largeTextField:!0,dependency:a.showAdvancedSettings}),a.advancedUseExperimentalThemeGenerator=new e("advancedUseExperimentalThemeGenerator",!1,"Use experimental theme generator",{dependency:a.showAdvancedSettings}),a.advancedDarkModeBackgroundColor=new e("advancedDarkModeBackgroundColor","#151f24","Dark mode background color",{dependency:a.advancedUseExperimentalThemeGenerator,colorPicker:!0}),a.advancedDarkModeContrastColor=new e("advancedDarkModeContrastColor","#00ffaa","Dark mode contrast color",{dependency:a.advancedUseExperimentalThemeGenerator,colorPicker:!0}),a.advancedCustomCSS=new e("advancedCustomCSS","","Custom CSS",{longDescription:"Custom CSS that will be applied to the page.",largeTextField:!0,dependency:a.showAdvancedSettings});let u=a;let p={main:`
            :root {
            ...
            .dark-mode {
                ${u.advancedUseExperimentalThemeGenerator()?(a=u.advancedDarkModeBackgroundColor(),t=u.advancedDarkModeContrastColor(),`
            --text-color: ${(n={textColor:n=d("#"+(16777215^parseInt(a.slice(1),16)).toString(16).padStart(6,"0").toUpperCase(),t,.8),textStrongColor:d(n,(e=>{e=e.replace("#","");let a=3===e.length?e.split("").map(e=>e+e).join(""):e;var[e,t,n]=[0,2,4].map(e=>parseInt(a.slice(e,e+2),16));return 128<.299*e+.587*t+.114*n})(a)?"#000000":"#ffffff",.2),backgroundColor:a,deeperBackgroundColor:o(a,-10),foregroundBackgroundColor:o(a,20),linkColor:t,highlightColor:d(a,t,.8),buttonBackgroundColor:d(a,t,.8),inputBackgroundColor:o(a,10),inputBorderColor:o(a,40),scrollbarColor:t,mnemonicMain:o(t,-20),mnemonicComponent:d(a,t,.9),progressBarForeground:`linear-gradient(${d(o(t,-40),n,.6)}, ${d(o(t,-120),n,.6)})`,focusedColor:d(o(t,-40),n,.8),whatIsThisColor:o(a,120),subsectionLabelColor:o(a,150),propertyTextColor:o(a,150),stateNew:t,stateBlacklisted:o(a,120),stateKnown:"#4fa825",stateOverdue:"#ff8c42",stateFailed:"#ff3b3b"}).textColor};
            --text-strong-color: ${n.textStrongColor};
            --background-color: ${n.backgroundColor};
            --deeper-background-color: ${n.deeperBackgroundColor};
            --foreground-background-color: ${n.foregroundBackgroundColor};
            --link-underline-color: ${n.linkColor};
            --link-color: ${n.linkColor};
            --highlight-color: ${n.highlightColor};
            --checkbox-focused-border-color: ${n.focusedColor};
            --checkbox-background-color: ${n.deeperBackgroundColor};
            --checkbox-focused-box-shadow-color: ${n.focusedColor};
            --button-background-color: ${n.buttonBackgroundColor};
            --button-focused-border-color: ${n.focusedColor};
            --outline-input-background-color-review: ${n.deeperBackgroundColor};
            --outline-input-background-color: ${n.inputBackgroundColor};
            --answer-box-color: ${n.foregroundBackgroundColor};
            --table-border-color: ${n.inputBorderColor};
            --spelling-box-background-color: ${n.highlightColor};
            --input-border-color: ${n.inputBorderColor};
            --input-background-color: ${n.inputBackgroundColor};
            --input-box-shadow-color: ${n.deeperBackgroundColor};
            --scrollbar-color: ${n.scrollbarColor};
            --scrollbar-background-color: ${n.deeperBackgroundColor};
            --mnemonic-main: ${n.mnemonicMain};
            --mnemonic-component: ${n.mnemonicComponent};
            --background-button-border-color: ${n.inputBorderColor};
            --big-shadow-color: ${o(n.deeperBackgroundColor,-10)};
            --progress-bar-background: ${n.foregroundBackgroundColor};
            --progress-bar-foreground: ${n.progressBarForeground};
            --progress-bar-in-progress: ${n.inputBorderColor};
            --review-button-group-border: ${n.inputBorderColor};

            --focused-arrow-color: ${n.focusedColor};
            --what-is-this-color: ${n.whatIsThisColor};
            --what-is-this-focus-color: ${n.focusedColor};
            --what-is-this-focus-shadow-color: ${n.highlightColor};
            --checkbox-color: ${n.focusedColor};
            --checkbox-focused-text-underline-color: ${n.focusedColor};
            --button-hover-border-color: ${n.focusedColor};
            --outline-input-color: ${n.focusedColor};

            --outline-input-shadow-color: ${n.focusedColor};
            --subsection-label-color: ${n.subsectionLabelColor};
            --table-header-color: ${n.subsectionLabelColor};
            --input-focused-border-color: ${n.focusedColor};

            --property-text-color: ${n.propertyTextColor};
            --state-new: ${n.stateNew};
            --state-blacklisted: ${n.stateBlacklisted};
            --state-known: ${n.stateKnown};
            --state-overdue: ${n.stateOverdue};
            --state-failed: ${n.stateFailed};
            `):`
                --text-color: #ddd;
...
${n.getLongDescription()}
                        ...
                        `:"boolean"==typeof n()?o+=`
                            <div style="margin-left: ${r};"${d}>
                            <div class="checkbox">
                                <input type="checkbox" id="${n.getName()}" name="${n.getName()}" ${n()?"checked":""}>
                                <label for="${n.getName()}">${n.getShortDescription()}</label>
                            </div>
                            ${n.getLongDescription()?`<p style="margin-left: 2rem; opacity: 0.8;">
${n.getLongDescription()}
                        ...
                        `:"number"==typeof n()?o+=`
                            <div style="margin-left: ${r};"${d}>
                                <label for="${n.getName()}">${n.getShortDescription()}</label>
                                <input style="max-width: 16rem;" type="number" id="${n.getName()}" name="${n.getName()}" step="any" value="${n()}">
                                ${n.getLongDescription()?`<p style="opacity: 0.8;">
${n.getLongDescription()}
</p>`:""}
                            </div>
                        `:n.getLargeTextField()?o+=`
                            <div style="margin-left: ${r};"${d}>
                                <label for="${n.getName()}">${n.getShortDescription()}</label>
                                ${n.getLongDescription()?`<p style="opacity: 0.8; margin-top: 0.5rem">
${n.getLongDescription()}
</p>`:""}
                                <textarea id="${n.getName()}" name="${n.getName()}" style="width: 100%; height: 10rem; margin-top: 0.5rem;" spellcheck="false">${n()}</textarea>
                            </div>
                        `:n.getColorPicker()?o+=`
                            <div style="margin-left: ${r};"${d}>
                                <label for="${n.getName()}">${n.getShortDescription()}</label>
                                <input type="color" id="${n.getName()}" name="${n.getName()}" value="${n()}" style="appearance: none; border: none; background: none;">
                                ${n.getLongDescription()?`<p style="opacity: 0.8;">
${n.getLongDescription()}
</p>`:""}
                            </div>
                        `:o+=`
                            <div style="margin-left: ${r};"${d}>
                                <label for="${n.getName()}">${n.getShortDescription()}</label>
                                <input style="max-width: 16rem;" type="text" id="${n.getName()}" name="${n.getName()}" value="${n()}">
                                ${n.getLongDescription()?`<p style="opacity: 0.8;">
${n.getLongDescription()}
</p>`:""}
                            </div>
                ...
                `;e.previousSibling.insertAdjacentHTML("beforebegin",l),document.getElementById("build-kanji-cache").addEventListener("click",function(e){e.preventDefault(),D()});let a=document.getElementById("reset-settings"),t=(a.addEventListener("click",function(e){e.preventDefault();GM_listValues().forEach(e=>{GM_deleteValue(e)});e=0===GM_listValues().length;a.parentElement.parentElement.querySelector("p").textContent=e?"Settings reset successfully.":"Settings reset failed.",c.submit()}),document.getElementById("reset-kanji-cache"));t.addEventListener("click",function(e){e.preventDefault(),new Promise((a,t)=>{var e=indexedDB.deleteDatabase(y.indexedDBName);e.onerror=e=>{console.error(`Error deleting database ${y.indexedDBName}:`,e.target.error),t(e.target.error)},e.onsuccess=e=>{console.log(`Database ${y.indexedDBName} successfully deleted`),a()},e.onblocked=e=>{console.warn(`Database ${y.indexedDBName} deletion blocked. Please close all other tabs with this site open.`)}}),t.parentElement.parentElement.querySelector("p").textContent="Kanji cache reset.",c.submit()});let n=new Map;for(i of Object.values(u))i.getDependency()&&n.set(i.getName(),function e(a,t=[]){a=a.getDependency();return a?(t.unshift(a),e(a,t)):t}(i));for([f,s]of n)for(let t of s){var b=c.querySelector(`[name="${t.getName()}"]`);b&&!b.dataset.hasChangeListener&&(b.addEventListener("change",function(){for(var[e,a]of n)a.includes(t)&&(e=c.querySelector(`[name="${e}"]`),a=a.some(e=>{e=c.querySelector(`[name="${e.getName()}"]`);return e&&!e.checked}),("checkbox"===e.type?e.parentElement:e).parentElement.classList.toggle("hidden",a),e.dispatchEvent(new Event("change")))}),b.dataset.hasChangeListener="true")}c.addEventListener("submit",function(e){e.preventDefault();for(var a of Object.values(u)){var t=c.querySelector(`input[name="${a.getName()}"]`)||c.querySelector(`textarea[name="${a.getName()}"]`),n=c.querySelector(`select[name="${a.getName()}"]`);t?"boolean"==typeof a()?a(t.checked):"number"==typeof a()?a(Number(t.value)):a(t.value):n&&a(n.value)}this.submit()})}}}async function U(){let a=!1;function o(e,n){var a=u.translationLanguage();var t,o,c,r,d=(t=(t=e)&&"string"==typeof t?(t=t.replace(/<script[^>]*>([\S\s]*?)<\/script>/gim,"")).replace(/<\/?\w(?:[^"'>]|"[^"]*"|'[^']*')*>/gim,""):t).normalize("NFKC"),i=(t=d,i=n,"None"!==(o=a)&&s[o]&&(o=s[o][t.trim()])?"string"==typeof o?o:"object"==typeof o&&o.text&&(!o.blacklist||!i.matches(o.blacklist))&&(!o.whitelist||i.matches(o.whitelist))?o.text:t:t);if(i!==d)return i;for([c,r]of Object.entries(s[a]))if(c.startsWith("/")&&c.endsWith("/")){var f=new RegExp(c.slice(1,-1));let t=d.trim().match(f);if(t){f="object"==typeof r?r.text:r;if("object"==typeof r){if(r.blacklist&&n.matches(r.blacklist))continue;if(r.whitelist&&!n.matches(r.whitelist))continue}let a=f;for(let e=0;e<t.length;e++)a=a.replace(new RegExp(`\\{${e}\\}`,"g"),()=>t[e]||"");return a}}return e}function t(){var e;a=!0;for(e of document.getElementsByTagName("*"))(n=>{if(n.nodeType===Node.ELEMENT_NODE&&!n.classList.contains("translated")){let t=!1;n.childNodes.forEach(e=>{var a;e.nodeType===Node.TEXT_NODE&&(a=e.textContent.trim())&&a!==(a=o(a,n))&&(e.textContent=a,t=!0)});var e;["placeholder","value","title","alt","aria-label"].forEach(e=>{var a;n.hasAttribute(e)&&(a=n.getAttribute(e))!==(a=o(a))&&(n.setAttribute(e,a),t=!0)}),"INPUT"===n.tagName&&"submit"===n.type&&(e=n.value)!==(e=o(e))&&(n.value=e,t=!0),"META"===n.tagName&&"description"===n.name&&(e=n.content)!==(e=o(e))&&(n.content=e,t=!0),t&&(n.setAttribute("lang",u.translationLanguage()),n.classList.add("translated"))}})(e);a=!1}new MutationObserver(e=>{a||(a=!0,e.forEach(e=>{"childList"===e.type?e.addedNodes.forEach(e=>{e.nodeType===Node.ELEMENT_NODE&&t()}):"attributes"===e.type&&t()}),a=!1)}).observe(document.body,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["placeholder","value","title","alt","aria-label"]}),t()}function K(){async function d(e,a=604800){var e=await h(`https://jpdb.io/search?q=${encodeURIComponent(e)}&lang=english#a`,a,!1,!1,!0,!1),t=(new DOMParser).parseFromString(e.responseText,"text/html").querySelector("#machine-translation");return t.classList.contains("translation-in-progress")?{success:!0,translation:(await h("https://jpdb.io/translation?id="+e.responseText.match(/translation\?id=(\d+)/)[1],a,!1,!1,!0,!1)).responseText.trim()}:t?{success:!0,translation:t.textContent.trim()}:{success:!1,translation:""}}function i(e){var e=e.cloneNode(!0),a=document.createElement("div");return a.appendChild(e),a.querySelectorAll("ruby rt").forEach(e=>e.remove()),a.innerText.replace(/<br>/g,"\n").replace(/\n/g," ").replace(/<[^>]*>/g,"").trim()}function a(){document.querySelectorAll(".used-in").forEach(e=>{let o=e.querySelector(".jp"),a=e.querySelector(".en");if(o&&!a){let n=document.createElement("div");n.classList.add("en"),n.classList.add("pending-translation"),n.textContent="Click to translate",e.appendChild(n);const c=604800;n.addEventListener("click",async function e(){var a=i(o),{success:a,translation:t}=(n.textContent="Translating...",await d(a,c));a?(n.textContent=t,n.classList.remove("pending-translation"),n.removeEventListener("click",e)):(n.textContent="Translation failed. Click to try again.",c=0)})}});let c=document.querySelector(".card-sentence");var e=document.querySelector(".review-reveal"),a=c?.parentElement?.querySelector(".sentence-translation");if(c&&!a&&e){let o=c.querySelector(".sentence");c.insertAdjacentHTML("afterend",'<div style="display: flex;justify-content: center;"><div class="sentence-translation" style="">Click to translate</div></div>');const r=604800;c.nextElementSibling.querySelector(".sentence-translation").addEventListener("click",async function e(){var a=i(o),t=c.nextElementSibling.querySelector(".sentence-translation"),{success:a,translation:n}=(t.textContent="Translating...",await d(a));a?(t.textContent=n,t.classList.remove("pending-translation"),t.removeEventListener("click",e)):(t.textContent="Translation failed. Click to try again.",r=0)})}}new MutationObserver(e=>{e.forEach(e=>{"childList"===e.type&&e.addedNodes.forEach(e=>{e.nodeType===Node.ELEMENT_NODE&&a()})})}).observe(document.body,{childList:!0,subtree:!0}),a()}function O(e,a){e=e.getBoundingClientRect();return a.getBoundingClientRect().top-e.bottom}function V(e,a){e=e.getBoundingClientRect();return a.getBoundingClientRect().top-e.top}async function R(){async function o(){let e=null;e=document.querySelector(".review-reveal")?await h("https://jpdb.io/stats",9999):await h("https://jpdb.io/stats",3);var a=(new DOMParser).parseFromString(e.responseText,"text/html").querySelectorAll("script");let t=null;if(a.forEach(e=>{e.textContent.includes('document.getElementById("chart")')&&(t=e)}),t){let e=t.textContent.match(new RegExp(/var\s?data\s?=\s?({\s?.+?\s?});/))[1];e=(e=e.replace(/(['"])?([a-zA-Z0-9_]+)(['"])?:/g,'"$2": ')).replace(/,(\s*[}\]])/g,"$1");var a=JSON.parse(e),n=a.datasets.find(e=>e.label.toLowerCase().includes("old")&&e.label.toLowerCase().includes("failed")),o=a.datasets.find(e=>e.label.toLowerCase().includes("old")&&e.label.toLowerCase().includes("passed")),a=a.datasets.find(e=>e.label.toLowerCase().includes("new"));return{oldCardsCount:n.data[n.data.length-1]+o.data[o.data.length-1],newCardsCount:a.data[a.data.length-1]}}return{oldCardsCount:0,newCardsCount:0}}async function t(){let e=(a=document.querySelector('.nav-item[href*="/learn"]').querySelector("span"))&&"red"===getComputedStyle(a).color||"rgb(255, 0, 0)"===getComputedStyle(a).color?Number(a.textContent):0;var{oldCardsCount:a,newCardsCount:t}=await o(),a=a+t,n=(0<t&&(n=await h("https://jpdb.io/settings",86400),n=(new DOMParser).parseFromString(n.responseText,"text/html").querySelector("#max-new-cards-per-day"),n=await Number(n.value),e+=n-t),document.createElement("div"));n.classList.add("review-progress"),n.style.position="fixed",n.style.top="0",n.style.left="0",n.style.zIndex="1000",n.style.padding="0.5rem",n.style.background="rgba(0, 0, 0, 0.5)",n.style.color="white",n.style.fontFamily="monospace",n.style.fontSize="1rem",n.style.fontWeight="bold",n.textContent=a+"/"+(a+e),document.querySelector(".review-progress")||document.body.appendChild(n)}t();let n=null;new MutationObserver(e=>{for(var a of e)a!==n&&(n=a,t())}).observe(document.body,{childList:!0,subtree:!0})}async function I(){var a=document.querySelector(".plain").cloneNode(!0);if(a){a.querySelectorAll("rt").forEach(e=>e.remove());var o=a.textContent.trim(),a=document.getElementById("upload-form");if(a){let s=document.createElement("div");s.id="yomi-custom-audio";var c,r=document.createElement("h6");r.textContent="External Audio Sources",r.style.marginTop="1rem",s.appendChild(r);let t=document.createElement("div"),n=(t.textContent="Loading extra audio sources...",s.appendChild(t),a.insertAdjacentElement("afterend",s),new Map),e=0;for(c of u.advancedYomiVocabAudioServer().split(",").map(e=>e.trim()).filter(e=>0<e.length))try{var d=(await h(c.replace("{term}",o),-1,!1,!1,!1,!1,"json")).response.audioSources;d&&0<d.length&&(e+=d.length),await(async a=>{let c=document.querySelector('input[type="file"]');if(c){let e=0;if(a&&0<a.length){"Loading extra audio sources..."===t.textContent&&(t.textContent="");for(let o of a)try{e++;var r=document.createElement("div"),d=(r.style.cssText=`
                            display: flex;
                            align-items: center;
                            padding: 5px;
                        `,document.createElement("span"));d.textContent=o.name||"Audio",d.style.marginRight="10px",r.appendChild(d);let t=document.createElement("audio");var i=document.createElement("a");i.classList.add("icon-link"),i.innerHTML='<i class="ti ti-volume"></i>',i.style.cursor="pointer";let n=null;i.onclick=async e=>{e.preventDefault(),n||(n=await l(o.url),t.src=n.blobUrl),t.paused?t.play():(t.pause(),t.currentTime=0)};var f=document.createElement("a");f.classList.add("icon-link"),f.innerHTML="+",f.style.margin="0 0.5rem",f.style.cursor="pointer",f.style.scale="1.25",f.onclick=async e=>{e.preventDefault(),n||(n=await l(o.url),t.src=n.blobUrl),t.play();var e=o.url.split("/").pop()||"audio.mp3",e=new File([n.blob],e,{type:n.blob.type}),a=new DataTransfer;a.items.add(e),c.files=a.files,c.dispatchEvent(new Event("change",{bubbles:!0}))},r.appendChild(t),r.appendChild(i),r.appendChild(f),s.appendChild(r)}catch(e){console.error(`Error setting up audio source for ${o.url}:`,e)}0===e&&(t.textContent="Failed to load any audio sources.",t.style.color="#ff4444")}}})(d)}catch(e){console.error(`Error fetching audio from ${c}:`,e)}async function l(e){if(n.has(e))return n.get(e);console.log("Fetching audio blob from:",e);var a=await(await h(e,-1,!1,!1,!1,!1,"blob")).response,t=URL.createObjectURL(a);return n.set(e,{blob:a,blobUrl:t}),{blob:a,blobUrl:t}}0===e&&(t.textContent="No audio sources found.",t.style.color="#ff4444")}}}function H(){function f(e,a){for(var t in a)e[t]?e[t].count+=a[t].count:e[t]=a[t];return e}function s(e){var e=Object.values(e),a=e.reduce((e,a)=>e+a.count,0),t=e.filter(e=>!(e.card_state||[]).includes("blacklisted")).reduce((e,a)=>e+a.count,0),n=e.filter(e=>(e.card_state||[]).includes("known")||(e.card_state||[]).includes("never-forget")||(e.card_state||[]).includes("blacklisted")).reduce((e,a)=>e+a.count,0),n=0<a?n/a:0,o=e.filter(e=>(e.card_state||[]).includes("known")||(e.card_state||[]).includes("never-forget")).reduce((e,a)=>e+a.count,0);return{total_occurrences:a,total_occurrences_excluding_blacklist:t,comprehension:n,comprehension_excluding_blacklist:0<t?o/t:0,unique_words:e.length,unique_words_excluding_blacklist:e.filter(e=>!(e.card_state||[]).includes("blacklisted")).length}}async function l(e){let t=[],n=[],o=0,a=(e.forEach(e=>{var a=e.length;3e3<o+a&&(t.push(n),n=[],o=0),n.push(e),o+=a}),n.length&&t.push(n),{}),c=t.length;for(var r of t){r=await(async e=>{var a,t,n=(e=await b("/parse",{text:e.join("\n"),token_fields:["vocabulary_index"],vocabulary_fields:["vid","sid","rid","spelling","reading","card_level","card_state"]})).vocabulary,o={};for(a of n)o[a[0]+"-"+a[1]]={spelling:a[3],reading:a[4],card_level:a[5],card_state:a[6],count:0};for(t of e.tokens){var c=n[t[0]];o[c[0]+"-"+c[1]].count++}return o})(r);a=f(a,r),0<--c&&await new Promise(e=>setTimeout(e,1e3))}return a}async function c(e){var a,t,n=new URL(window.location.href);n.pathname+="/results",window.history.pushState({},"",n);let o=document.querySelector(".container");function c(e,a){"Analyzing..."===o.innerHTML&&(o.innerHTML="");var t=document.createElement("h4"),e=(t.textContent=e,o.appendChild(t),document.createElement("div"));e.style.marginBottom="1rem",e.textContent=`Comprehension: ${Math.round(100*a.comprehension_excluding_blacklist)}%`,o.appendChild(e)}o&&(o.innerHTML="Analyzing..."),e.sort((e,a)=>e[0].localeCompare(a[0]));let r={},d=e.length;for([a,t]of e){var i=await l((e=>{var a,t=new RegExp("^♪♪(.|\\n)*|(.|\\n)*♪♪$|^([(（]([^()（）]|(([(（][^()（）]+[)）])))+[)）])$|^\\[.*\\]$|^♪〜.*|^♪♪.*|.*〜♪|.*～♪|^♪～.*$|\\([^)]*\\)|（.*?）|^♬～.*|《[^》]*》|[（）＜＞]|[→➡]+|♬～|♬♬|～♬|♪～|～♪|♪♪|♪♪～|～♪♪|♬♬～|～♬♬|♪〜|〜♪"),n=[];for(a of e)(a=(a=a.replace(/\\N/g,"\n")).replace(t,"").trim())&&n.push(a);return n})((i=t,/\d{2}:\d{2}:\d{2},\d{3} --> \d{2}:\d{2}:\d{2},\d{3}/.test(i)?i.trim().split("\n\n").map(e=>e.split("\n").slice(2).join(" ").trim()).filter(e=>0<e.length):i.split("\n").map(e=>e.trim()).filter(e=>0<e.length)))),i=(r=f(r,i),s(i));c(a,i),0<--d&&await new Promise(e=>setTimeout(e,1e3))}1<e.length&&c("Combined",s(r))}var e=document.querySelector(".container");if(e){document.title="Custom Comprehension Analyzer",e.innerHTML="";var n=document.createElement("h4"),n=(n.textContent="Custom Comprehension Analyzer",e.appendChild(n),document.createElement("p")),n=(n.textContent=`This is a custom comprehension analyzer injected by ${GM_info.script.name}.`,e.appendChild(n),document.createElement("p")),n=(n.textContent="Input raw text or the contents of an .srt file into the text box or using the file input below.",e.appendChild(n),document.createElement("form")),n=(n.style.display="inline",n.innerHTML=`
        ...
        `,n.addEventListener("submit",async e=>{e.preventDefault();e=e.target.text.value;console.log(e),c([["Text",e]])}),e.appendChild(n),document.createElement("form")),e=(n.style.display="inline",n.innerHTML=`
                    ...
                    <input type="submit" value="Analyze" class="outline" style="display: block;">
                `,n.addEventListener("submit",async e=>{e.preventDefault();var e=e.target.file.files,a=[];let n=[];for(let t of e){var o=new Promise(a=>{var e=new FileReader;e.onload=function(e){e=e.target.result;n.push([t.name,e]),a()},e.readAsText(t)});a.push(o)}await Promise.all(a),c(n)}),e.appendChild(n),document.getElementById("select-file-input"));let a=document.getElementById("select-file-input-label"),t=document.getElementById("selected-files");e.addEventListener("change",e=>{e=Array.from(e.target.files);0<e.length?(a.textContent=e.length+" file(s) selected",t.innerHTML=`<div>${e.map(e=>e.name).join(", ")}</div>`):(a.textContent="Select file...",t.innerHTML="")})}}async function W(){var e;Date.now()-i.lastChangelogCheck<864e5||(e=await(await fetch("https://jpdb.io/changelog")).text(),e=(new DOMParser).parseFromString(e,"text/html"),e=await Array.from(e.querySelectorAll("h5")).map(e=>e.id).sort().reverse()[0],i.lastChangelogDate&&0<i.lastChangelogDate&&e&&Number(e)!==i.lastChangelogDate&&GM_notification({title:"New JPDB Changelog",text:"There is a new changelog available on JPDB",image:"https://jpdb.io/favicon.ico",onclick:()=>{window.open("https://jpdb.io/changelog")}}),GM_setValue("lastChangelogDate",Number(e)),GM_setValue("lastChangelogCheck",Date.now()))}function N(){if(g(),(async()=>{let e="https://fonts.googleapis.com/css2?family=Manrope:wght@200..800&display=swap",a=await h(e,86400,!0,!1,!0,!1);if(a&&GM_addStyle(a.responseText),u.enableButtonStyling()&&s[u.translationLanguage()]["config.reviewButtonFontWeight"]){let e=await h("https://fonts.googleapis.com/css2?family=Noto+Sans+JP:wght@100..900&display=swap",86400,!0,!1,!0,!1);e&&(GM_addStyle(e.responseText),GM_addStyle(`
                    .review-button-group input[type="submit"] {
                        font-family: 'Noto Sans JP', sans-serif;
                        font-weight: ${s[u.translationLanguage()]["config.reviewButtonFontWeight"]} !important;
                    }
                `))}})(),window.location.href===y.learnPageUrl){w(),m();let t=null;new MutationObserver(e=>{for(var a of e)if("childList"===a.type&&a.target.classList.contains(y.deckListClass)&&!a.target.classList.contains(y.newDeckListClass)){a!==t&&(w(),m(),t=a);break}}).observe(document.body,{childList:!0,subtree:!0})}else window.location.href.startsWith(y.reviewPageUrlPrefix)&&u.enableButtonStyling()&&(async()=>{function e(){var e;performance&&performance.timing&&(e=(e=performance.timing).loadEventEnd-e.navigationStart,GM_setValue("reviewPageLoadTime",e))}if(E(),-1===u.buttonSoundDelay()&&window.addEventListener("load",function(){setTimeout(e,0)}),u.enableButtonEffects()&&!i.cachedEffects){var a,t=[].concat(y.lottieSparkles,y.lottieSmallFireworks,y.lottieBigFireworks);console.log("Caching review button effects:",t);for(a of t)await h(a,31536e3,!0,!1,!0);i.cachedEffects=!0,GM_setValue("cachedEffects",!0)}new MutationObserver(e=>{e.forEach(e=>{"childList"===e.type&&e.addedNodes.forEach(e=>{e.nodeType===Node.ELEMENT_NODE&&(e.classList.contains("review-button-group")?E():e.querySelectorAll(y.reviewButtonSelector).forEach(C))})})}).observe(document.body,{childList:!0,subtree:!0})})();if(window.location.href.startsWith(y.reviewPageUrlPrefix)&&u.enableVerticalSentence()){function n(){if(4/3<window.innerWidth/document.querySelector(".container").clientWidth){var e=document.querySelector(".card-sentence"),a=document.querySelector(".container");e&&a&&(t=e.getBoundingClientRect(),a=a.getBoundingClientRect().bottom-t.top,e.style="",e.style.height=Math.max(a,10)+"px",e.style.right="unset",e.style.left="100%")}else{var t=document.querySelector(".sentence .icon-link"),a=document.getElementById("show-checkbox-examples-label"),e=[],n=(t&&a&&(n=O(t,a),e.push(Math.round(n)+"px")),document.querySelector(".review-button-group")),o=(t&&n&&(o=O(t,n),e.push(Math.round(o)+"px")),document.querySelector(".card-sentence"));if(!t){if(!o)return;a&&(t=V(o,a),e.push(Math.round(t)+"px")),n&&(a=V(o,n),e.push(Math.round(a)+"px"))}o&&(o.style="",o.style.height=`calc(max(10px, min(${e.join(", ")}) * 0.99)`)}}GM_addStyle(p.verticalSentence),n();let t=null;new MutationObserver(e=>{for(var a of e)a!==t&&(t=a,n())}).observe(document.body,{childList:!0,subtree:!0}),window.addEventListener("resize",n)}var e,a,t;if(window.location.href.startsWith(y.reviewPageUrlPrefix)&&((async()=>{let r={locked:!1,queue:[],lock:async function(){this.locked&&await new Promise(e=>this.queue.push(e)),this.locked=!0},unlock:function(){this.locked=!1;var e=this.queue.shift();e&&e()}};async function t(){if(!document.querySelector(".inserted-dropdown")){await r.lock();try{var e,a,t,n,o,c;document.querySelector(".inserted-dropdown")||(e=document.querySelector(".answer-box"))&&(a=e.querySelector('a[href*="/vocabulary/"]'))&&(t=await h(new URL(a.href,window.location.origin).href,-1),n=(new DOMParser).parseFromString(t.responseText,"text/html").querySelector(".menu .dropdown"))&&(n=n.parentElement,o=e.querySelector(".plain"))&&(n.classList.add("inserted-dropdown"),n.style.justifyContent="flex-start",n.style.fontSize="1rem",n.style.fontFamily=getComputedStyle(document.body).fontFamily,o.insertBefore(n,o.firstChild),c=n.getBoundingClientRect().width,n.style.marginRight=`-${c}px`)}finally{r.unlock()}}}await t();let n=null;new MutationObserver(async e=>{for(var a of e)a!==n&&(n=a,await t())}).observe(document.body,{childList:!0,subtree:!0})})(),GM_addStyle(p.fixCenteredAnswerBox)),window.location.href.startsWith(y.reviewPageUrlPrefix)&&c.enableProgress&&R(),window.location.href!==y.learnPageUrl&&window.location.href!=y.deckListPageUrl||q(),window.location.href===y.settingsPageUrl&&F(),u.enableReplaceKanjiStrokeOrder()&&P(),"None"!==u.translationLanguage()&&U(),u.autoExpandNavMenu()&&window.location.href.startsWith(y.reviewPageUrlPrefix)&&(e=document.getElementById("menu-btn"),a=document.querySelector(".menu"),(t=document.createElement("style")).textContent=`
        ...
        `,document.head.appendChild(t),e.checked=!0,a.offsetHeight,document.head.removeChild(t)),u.showHiddenVocabularyOnBack()&&window.location.href.startsWith(y.reviewPageUrlPrefix)){let t=null;function o(){var e,a=document.querySelector(".review-reveal");a&&(a=a.querySelector(".answer-box > .plain"))&&("none"===a.style.display||"none"===getComputedStyle(a).display)&&(e=(a.getAttribute("style")||"").split(";").map(e=>e.trim()).filter(e=>e.startsWith("display:")?"none"!==e.split(":")[1].trim():0<e.length).join("; "),a.setAttribute("style",e),t)&&(t.disconnect(),t=null)}o(),document.querySelector(".review-reveal")||(t=new MutationObserver(()=>{o()})).observe(document.body,{childList:!0,subtree:!0})}T(),new MutationObserver(e=>{e.forEach(e=>{"childList"===e.type&&e.addedNodes.forEach(e=>{e&&e.classList&&e.classList.contains("subsection-composed-of-kanji")?T():e&&e.querySelectorAll&&e.querySelectorAll(".subsection-composed-of-kanji").forEach(e=>{T()})})})}).observe(document.body,{childList:!0,subtree:!0}),G(),document.addEventListener("keydown",function(e){"/"===e.key&&z(e)}),u.enableSentenceBlur()&&(GM_addStyle(p.sentenceBlur),document.addEventListener("click",function(e){e.target.classList.contains("sentence-translation")&&e.target.classList.toggle("unblur")}),document.addEventListener("keydown",function(e){"c"===e.key&&document.querySelectorAll(".sentence-translation").forEach(e=>{e.click()})})),u.enableMonolingualMachineTranslation()&&K(),u.enableButtonSound()&&(async()=>{i.audioContext.ctx||(i.audioContext.ctx=new(window.AudioContext||window.webkitAudioContext))})(),window.location.href.startsWith(y.shownSentencePrefix)&&(async()=>{var e,a,t,n=document.querySelector('form[action*="edit-shown-sentence"]');n&&(n=n.closest("div").querySelector("h5"))&&((e=document.createElement("button")).classList.add("sentence-clear-button"),e.title="Clear sentence via API",(a=document.createElementNS("http://www.w3.org/2000/svg","svg")).setAttribute("xmlns","http://www.w3.org/2000/svg"),a.setAttribute("viewBox","0 0 24 24"),a.classList.add("sentence-clear-button-svg"),a.innerHTML='<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" fill="#2v14c0"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M14.12 10.47L12 12.59l-2.13-2.12-1.41 1.41L10.59 14l-2.12 2.12 1.41 1.41L12 15.41l2.12 2.12 1.41-1.41L13.41 14l2.12-2.12zM15.5 4l-1-1h-5l-1 1H5v2h14V4zM6 19c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V7H6v12zM8 9h8v10H8V9z"/></svg>',t=window.getComputedStyle(n),a.style.width=t.fontSize,a.style.height=t.fontSize,e.appendChild(a),e.addEventListener("click",async()=>{var e=new URL(window.location.href),a=e.searchParams.get("v"),e=e.searchParams.get("s"),t=(console.log(a,e),confirm("Are you sure you want to clear the sentence?"));t&&(await b("/set-card-sentence",{vid:Number(a),sid:Number(e),sentence:"",clear_audio:!0}),window.location.reload())}),n.appendChild(e))})(),window.location.href.startsWith(y.editAudioPrefix)&&u.advancedYomiVocabAudioServer()&&I(),window.location.href===y.customComprehensionAnalyzerUrl&&H(),i.currentVersion!==GM_info.script.version&&(GM_setValue("debug_lastVersion",i.currentVersion),i.lastVersion=i.currentVersion,GM_setValue("debug_currentVersion",GM_info.script.version),i.currentVersion=GM_info.script.version),W(),document.dispatchEvent(new CustomEvent(GM_info.script.name+"-initialized"))}try{g()}catch(e){}if("loading"===document.readyState)document.addEventListener("DOMContentLoaded",N);else try{N()}catch(e){}}();
